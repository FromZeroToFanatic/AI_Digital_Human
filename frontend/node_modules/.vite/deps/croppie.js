        ...
        !(function(a) {
          ...
          function d(a2) {
            ...
            return null === this._state ? void this._deferreds.push(a2) : void k(function() {
              ...
              if (null === c2) return void (b2._state ? a2.resolve : a2.reject)(b2._value);
              var d2;
              try {
                d2 = c2(b2._value);
              } catch (e2) {
          ...
          function e(a2) {
            try {
              if (a2 === this) throw new TypeError("A promise cannot be resolved with itself.");
              if (a2 && ("object" === typeof a2 || "function" === typeof a2)) {
                var c2 = a2.then;
                if ("function" === typeof c2) return void i(b(c2, a2), b(e, this), b(f, this));
              }
          ...
          function g() {
            for (var a2 = 0, b2 = this._deferreds.length; b2 > a2; a2++) d.call(this, this._deferreds[a2]);
              ...
              function d2(f3, g2) {
                try {
                  if (g2 && ("object" === typeof g2 || "function" === typeof g2)) {
                    var h2 = g2.then;
                    if ("function" === typeof h2) return void h2.call(g2, function(a3) {
                      d2(f3, a3);
                    }, c2);
                  }
                  a2[f3] = g2, 0 === --e2 && b2(a2);
