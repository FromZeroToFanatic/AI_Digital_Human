...
var require_asset_path = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/asset-path.js"(exports) {
    "use strict";
...
var require_default_model_fetcher = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/default-model-fetcher.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_logging = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/logging.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.log = void 0;
...
var require_messages = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/messages.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_frame_processor = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/frame-processor.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_ort_min = __commonJS({
  "node_modules/onnxruntime-web/dist/ort.min.js"(exports, module) {
    ...
    var ort = (() => {
      ...
      var vn = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof __require < "u" ? __require : t)[n] }) : e)(function(e) {
      ...
      var rt = (e, t) => {
        ...
        if (t && typeof t == "object" || typeof t == "function") for (let o of Lu(t)) !Gu.call(e, o) && o !== n && $n(e, o, { get: () => t[o], enumerable: !(r = Nu(t, o)) || r.enumerable });
        return e;
      };
      var lt = (e) => Wu($n({}, "__esModule", { value: true }), e);
      var St, Ze, Ge, Hu, br, xn = k(() => {
        "use strict";
        St = /* @__PURE__ */ new Map(), Ze = [], Ge = (e, t, n) => {
          if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
            ...
            if (n >= 0) {
              let o = Ze.indexOf(e);
              o !== -1 && Ze.splice(o, 1);
              for (let i = 0; i < Ze.length; i++) if (St.get(Ze[i]).priority <= n) {
                Ze.splice(i, 0, e);
                return;
              }
              Ze.push(e);
          ...
          let t = e.executionProviders || [], n = t.map((u) => typeof u == "string" ? u : u.name), r = n.length === 0 ? Ze : n, o, i = [], s = /* @__PURE__ */ new Set();
          for (let u of r) {
            let d = await Hu(u);
      ...
      var vr, le, Sn = k(() => {
        "use strict";
        $r();
        vr = "warning", le = { wasm: {}, webgl: {}, webgpu: {}, versions: { common: wr }, set logLevel(e) {
          if (e !== void 0) {
        ...
        Object.defineProperty(le, "logLevel", { enumerable: true });
      });
      var te, xr = k(() => {
        "use strict";
        Sn();
      ...
      var Sr, Tr, Ir = k(() => {
        ...
        Sr = (e, t) => {
          ...
          if (r != null) {
            ...
            for (let h = 0; h < i; h++) for (let b = 0; b < o; b++) {
          ...
          if (n != null) {
            ...
            for (let v = 0; v < i * o; f += p, m += p, h += p, b += p, v++) r.data[f] = (e.data[y++] - l[0]) * d[0], r.data[m] = (e.data[g++] - l[1]) * d[1], r.data[h] = (e.data[_++] - l[2]) * d[2], r.data[b] = w === -1 ? 255 : (e.data[w++] - l[3]) * d[3];
          } else throw new Error("Can not access image data");
          return r;
        };
      });
      var Tn, Cr, Ar, Er, kr, Pr, zr = k(() => {
        ...
        Tn = (e, t) => {
          ...
          for (let v = 0; v < d; v++, p += c, m += c, f += c, h += c) l[b++] = (e[p] + s[0]) / i[0], l[y++] = (e[f] + s[1]) / i[1], l[g++] = (e[m] + s[2]) / i[2], _ !== -1 && h !== -1 && (l[_++] = (e[h] + s[3]) / i[3]);
      ...
      var pt, Vr, ye, he, Ue, Re, Cn = k(() => {
        "use strict";
        Sn();
        pt = (e, t) => {
          (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) || console.timeStamp(`${e}::ORT::${t}`);
        }, Vr = (e, t) => {
          ...
          (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) || Vr("BEGIN", e);
        }, he = (e) => {
          (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) || Vr("END", e);
        }, Ue = (e) => {
          (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) || console.time(`ORT::${e}`);
        }, Re = (e) => {
          (typeof le.trace > "u" ? !le.wasm.trace : !le.trace) || console.timeEnd(`ORT::${e}`);
        };
      });
      var It, Nr = k(() => {
        "use strict";
        ...
        It = class e {
          ...
          async run(t, n, r) {
            ye(), Ue("InferenceSession.run");
            let o = {}, i = {};
            if (typeof t != "object" || t === null || t instanceof xe || Array.isArray(t)) throw new TypeError("'feeds' must be an object that use input names as keys and OnnxValue as corresponding values.");
            let s = true;
            if (typeof n == "object") {
              if (n === null) throw new TypeError("Unexpected argument[1]: cannot be null.");
              if (n instanceof xe) throw new TypeError("'fetches' cannot be a Tensor");
              if (Array.isArray(n)) {
            ...
            return Re("InferenceSession.run"), he(), u;
          }
          async release() {
            return this.handler.dispose();
          }
          static async create(t, n, r, o) {
            ye(), Ue("InferenceSession.create");
            let i, s = {};
            if (typeof t == "string") {
            ...
            return Re("InferenceSession.create"), he(), new e(d);
          }
          startProfiling() {
      ...
      var An = {};
      rt(An, { InferenceSession: () => Lr, TRACE: () => pt, TRACE_EVENT_BEGIN: () => Ue, TRACE_EVENT_END: () => Re, TRACE_FUNC_BEGIN: () => ye, TRACE_FUNC_END: () => he, Tensor: () => xe, env: () => te, registerBackend: () => Ge });
      var _e = k(() => {
        "use strict";
        _r();
        xr();
      ...
      var jr, Zr, qu, Xr = k(() => {
        ...
        Zr && (self.onmessage = (e) => {
          ...
          try {
            switch (t) {
              ...
              case "release":
                Bt(n), postMessage({ type: t });
                break;
              case "run": {
                let { sessionId: r, inputIndices: o, inputs: i, outputIndices: s, options: a } = n;
                Dt(r, o, i, s, new Array(s.length).fill(null), a).then((u) => {
                  u.some((d) => d[3] !== "cpu") ? postMessage({ type: t, err: "Proxy does not support non-cpu tensor location." }) : postMessage({ type: t, out: u }, Mt([...i, ...u]));
                }, (u) => {
        ...
        qu = Zr ? null : (e) => new Worker(e ?? we, { type: "classic", name: jr });
      });
      var Fu, Ku, we, Ut, kn, ju, Zu, eo, Qu, Yr, to, Jr, no, At = k(() => {
        "use strict";
        Ct();
        Fu = typeof location > "u" ? void 0 : location.origin, Ku = () => {
          ...
          try {
            let n = t ?? we;
            return (n ? new URL(e, n) : new URL(e)).origin === Fu;
          } catch {
            return false;
          }
        }, ju = (e, t) => {
        ...
        }, Qu = async (e) => (await import(
          /*webpackIgnore:true*/
          /*@vite-ignore*/
          e
        )).default, Yr = (Xr(), lt(Qr)).default, to = async () => {
          if (!we) throw new Error("Failed to load proxy worker: cannot determine the script source URL.");
          if (kn(we)) return [void 0, Yr()];
          let e = await eo(we);
          return [e, Yr(e)];
        }, Jr = void 0, no = async (e, t, n, r) => {
          let o = Jr && !(e || t);
          if (o) if (we) o = kn(we) || r && !n;
          else if (r && !n) o = true;
          else throw new Error("cannot determine the script source URL.");
          if (o) return [void 0, Jr];
          {
            let i = "ort-wasm-simd-threaded.jsep.mjs", s = e ?? ju(i, t), a = n && s && !kn(s, t), u = a ? await eo(s) : s ?? Zu(i, t);
            return [a ? u : void 0, await Qu(u)];
          }
        };
      });
      var Pn, zn, Rt, ro, Xu, Yu, Ju, Et, ne, We = k(() => {
        "use strict";
        At();
        zn = false, Rt = false, ro = false, Xu = () => {
          ...
          if (Rt) throw new Error("multiple calls to 'initializeWebAssembly()' detected.");
          if (ro) throw new Error("previous call to 'initializeWebAssembly()' failed.");
          Rt = true;
          let t = e.initTimeout, n = e.numThreads;
          if (e.simd !== false) {
            if (e.simd === "relaxed") {
              if (!Ju()) throw new Error("Relaxed WebAssembly SIMD is not supported in the current environment.");
          ...
          if (t > 0 && m.push(new Promise((h) => {
            ...
            p(y).then((g) => {
              Rt = false, zn = true, Pn = g, h(), c && URL.revokeObjectURL(c);
            }, (g) => {
              Rt = false, ro = true, b(g);
            });
      ...
      var oo, io = k(() => {
        ...
        oo = (e) => {
          ...
          try {
            ...
            let i = 0;
            return e?.tag !== void 0 && (i = $e(e.tag, r)), n = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), n === 0 && Y("Can't create run options."), e?.extra !== void 0 && ft(e.extra, "", /* @__PURE__ */ new WeakSet(), (s, a) => {
              let u = $e(s, r), d = $e(a, r);
      ...
      var ed, td, nd, Nt, rd, so, ao = k(() => {
        ...
        ed = (e) => {
          ...
          for (let o of r) {
              ...
              case "webgpu":
                if (i = "JS", typeof o != "string") {
                  ...
                  if (c?.preferredLayout) {
                    ...
                    Nt(e, "preferredLayout", c.preferredLayout, n);
                  }
                }
                break;
              case "wasm":
            ...
            let a = $e(i, n), u = s.length, d = 0, l = 0;
            if (u > 0) {
              d = ne()._malloc(u * ne().PTR_SIZE), n.push(d), l = ne()._malloc(u * ne().PTR_SIZE), n.push(l);
              for (let c = 0; c < u; c++) ne().setValue(d + c * ne().PTR_SIZE, s[c][0], "*"), ne().setValue(l + c * ne().PTR_SIZE, s[c][1], "*");
            }
          ...
          nd(o);
          try {
            let i = ed(o.graphOptimizationLevel ?? "all"), s = td(o.executionMode ?? "sequential"), a = typeof o.logId == "string" ? $e(o.logId, r) : 0, u = o.logSeverityLevel ?? 2;
            ...
            let l = typeof o.optimizedModelFilePath == "string" ? $e(o.optimizedModelFilePath, r) : 0;
            if (n = t._OrtCreateSessionOptions(i, !!o.enableCpuMemArena, !!o.enableMemPattern, s, !!o.enableProfiling, 0, a, u, d, l), n === 0 && Y("Can't create session options."), o.executionProviders && await rd(n, o, r), o.enableGraphCapture !== void 0) {
              if (typeof o.enableGraphCapture != "boolean") throw new Error(`enableGraphCapture must be a boolean value: ${o.enableGraphCapture}`);
              Nt(n, "enableGraphCapture", o.enableGraphCapture.toString(), r);
            }
            ...
            return o.extra !== void 0 && ft(o.extra, "", /* @__PURE__ */ new WeakSet(), (c, p) => {
              Nt(n, c, p, r);
            }), [n, r];
          } catch (i) {
      ...
      var He, Ee, qe, ot, ht, Lt, Gt, Bn, L = k(() => {
        "use strict";
        He = (e) => {
          switch (e) {
            case "int8":
        ...
        }, Lt = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", Gt = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint64" || e === "int8" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", Bn = (e) => {
          switch (e) {
            case "none":
              return 0;
            case "cpu":
      ...
      var gt, Dn = k(() => {
        ...
        gt = async (e) => {
          if (typeof e == "string") if (false) try {
            let { readFile: t } = vn("node:fs/promises");
            return new Uint8Array(await t(e));
          } catch (t) {
            if (t.code === "ERR_FS_FILE_TOO_LARGE") {
              let { createReadStream: n } = vn("node:fs"), r = n(e), o = [];
      ...
      var od, id, uo, lo, Wt, sd, Z, ke = k(() => {
        "use strict";
        L();
        od = ["V", "I", "W", "E", "F"], id = (e, t) => {
          console.log(`[${od[e]},${(/* @__PURE__ */ new Date()).toISOString()}]${t}`);
        }, Wt = (e, t) => {
          uo = e, lo = t;
        }, sd = (e, t) => {
          let n = ht(e), r = ht(uo);
      ...
      var On, Pe, x, Ye, Ht, co, po, F = k(() => {
        ...
        On = class {
          ...
          static getShapeOfGemmResult(t, n, r, o, i) {
            ...
            if (i && !Pe.isValidBroadcast(i, [s, u])) throw new Error("gemm: invalid bias shape for broadcast");
            return [s, u, a];
          }
      ...
      var fo, Rn, ho, ad, mo, ud, go, Ft, Kt, Un, yo, bo = k(() => {
        "use strict";
        L();
        ke();
        fo = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), Rn = (e, t) => {
        ...
        }, ad = 1, mo = () => ad++, ud = /* @__PURE__ */ new Map([["int8", "int32"], ["uint8", "int32"], ["uint32", "int32"], ["int64", "int32"]]), go = (e, t) => {
          let n = fo.get(e);
          ...
          async ensureTensor(t, n, r, o) {
            ...
            if (!s?.input.dataTypes.includes(n)) {
              if (a = ud.get(n), !a || s?.input.dataTypes.includes(a)) throw new Error(`WebNN backend does not support data type: ${n}`);
      ...
      var jt, dd, Zt, _o = k(() => {
        ...
        bo();
        ke();
        jt = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), dd = (e, t) => {
          if (e === t) return true;
          ...
          uploadTensor(t, n) {
            if (!ne().shouldTransferToMLTensor) throw new Error("Trying to upload to a MLTensor while shouldTransferToMLTensor is false");
      ...
      var wo, Vn, Nn, ld, cd, $o, Gn, Ln, xo, So = k(() => {
        "use strict";
        ke();
        Qt();
        wo = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), Vn = [], Nn = (e) => Math.ceil(Number(e) / 16) * 16, ld = (e) => {
          ...
          async download(t, n) {
            ...
            await Gn(this.backend, r.gpuData.buffer, r.originalSize, n);
          }
      ...
      var Je, qn, re, ce, P, J, Fn, et, Te, B, Xt, S, C, To, Yt, Hn, Io, j = k(() => {
        "use strict";
        L();
        F();
        Je = 64, qn = (e, t) => {
          ...
          let i = typeof n == "number", s = i ? n : n.length, a = [...new Array(s).keys()], u = s < 2 ? "u32" : s <= 4 ? `vec${s}<u32>` : `array<u32, ${s}>`, d = qn(t, o), l = typeof d == "string" ? d : d[1], c = typeof d == "string" ? d : d[0], p = { indices: u, value: l, storage: c, tensor: t }, f = (E) => typeof E == "string" ? E : `${E}u`, m = { offsetToIndices: false, indicesToOffset: false, broadcastedIndicesToOffset: false, set: false, setByIndices: false, get: false, getByIndices: false }, h = i ? "uniforms." : "", b = `${h}${e}_shape`, y = `${h}${e}_strides`, g = "";
          for (let E = 0; E < s - 1; E++) g += `
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    ${g}
    return indices;
  }`, w = (E) => (m.offsetToIndices = true, s < 2 ? E : `o2i_${e}(${E})`), v = [];
          if (s >= 2) for (let E = s - 1; E >= 0; E--) v.push(`${B(y, E, s)} * (indices[${E}])`);
          let $ = s < 2 ? "" : `
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
  }`, T = (E) => (m.indicesToOffset = true, s < 2 ? E : `i2o_${e}(${E})`), I = (...E) => s === 0 ? "0u" : `${p.indices}(${E.map(f).join(",")})`, A = (E, N) => s < 2 ? `${E}` : `${B(E, N, s)}`, z = (E, N, se) => s < 2 ? `${E}=${se};` : `${B(E, N, s)}=${se};`, R = {}, D = (E, N) => {
            m.broadcastedIndicesToOffset = true;
            let se = `${N.name}broadcastedIndicesTo${e}Offset`;
            if (se in R) return `${se}(${E})`;
            let ve = [];
            for (let ge = s - 1; ge >= 0; ge--) {
              let je = N.indicesGet("outputIndices", ge + N.rank - s);
              ve.push(`${A(y, ge)} * (${je} % ${A(b, ge)})`);
            }
            return R[se] = `fn ${se}(outputIndices: ${N.type.indices}) -> u32 {
             return ${ve.length > 0 ? ve.join("+") : "0u"};
           }`, `${se}(${E})`;
          }, U = (E, N) => (() => {
            if (p.storage === p.value) return `${e}[${E}]=${N};`;
            if (p.storage === "vec2<u32>" && p.value === "i32") return `${e}[${E}]=vec2<u32>(u32(${N}), select(0u, 0xFFFFFFFFu, ${N} < 0));`;
            if (p.storage === "vec2<u32>" && p.value === "u32") return `${e}[${E}]=vec2<u32>(u32(${N}), 0u);`;
            if (p.storage === "u32" && p.value === "vec4<bool>") return `${e}[${E}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${N}));`;
            throw new Error(`not supported combination of storage type ${p.storage} and value type ${p.value} yet`);
          })(), Q = (E) => (() => {
            if (p.storage === p.value) return `${e}[${E}]`;
            if (p.storage === "vec2<u32>" && p.value === "i32") return `i32(${e}[${E}].x)`;
            if (p.storage === "vec2<u32>" && p.value === "u32") return `u32(${e}[${E}].x)`;
            if (p.storage === "u32" && p.value === "vec4<bool>") return `vec4<bool>(bool(${e}[${E}] & 0xFFu), bool(${e}[${E}] & 0xFF00u), bool(${e}[${E}] & 0xFF0000u), bool(${e}[${E}] & 0xFF000000u))`;
            throw new Error(`not supported combination of storage type ${p.storage} and value type ${p.value} yet`);
          })(), O = s < 2 ? "" : `
  fn get_${e}ByIndices(indices: ${p.indices}) -> ${l} {
    return ${Q(`i2o_${e}(indices)`)};
  }`, M = s < 2 ? "" : (() => {
            let E = a.map((se) => `d${se}: u32`).join(", "), N = a.map((se) => `d${se}`).join(", ");
            return `
  fn get_${e}(${E}) -> ${l} {
    return get_${e}ByIndices(${I(N)});
            ...
            let N = E.map(f).join(",");
            return s === 0 ? Q("0u") : s === 1 ? Q(N[0]) : (m.get = true, m.getByIndices = true, m.indicesToOffset = true, `get_${e}(${N})`);
          }, W = (E) => s < 2 ? Q(E) : (m.getByIndices = true, m.indicesToOffset = true, `get_${e}ByIndices(${E})`), H = s < 2 ? "" : `
  ...
  fn set_${e}(${E}, value: ${l}) {
    set_${e}ByIndices(${I(N)}, value);
          ...
          return { impl: () => {
            let E = [], N = false;
            return m.offsetToIndices && (E.push(_), N = true), m.indicesToOffset && (E.push($), N = true), m.broadcastedIndicesToOffset && (Object.values(R).forEach((se) => E.push(se)), N = true), m.set && (E.push(X), N = true), m.setByIndices && (E.push(H), N = true), m.get && (E.push(M), N = true), m.getByIndices && (E.push(O), N = true), !i && N && E.unshift(`const ${b} = ${p.indices}(${n.join(",")});`, `const ${y} = ${p.indices}(${x.computeStrides(n).join(",")});`), E.join(`
`);
          }, type: p, offsetToIndices: w, indicesToOffset: T, broadcastedIndicesToOffset: D, indices: I, indicesGet: A, indicesSet: z, set: (...E) => {
            if (E.length !== s + 1) throw new Error(`indices length must be ${s}`);
            let N = E[s];
            if (typeof N != "string") throw new Error("value must be string");
            let se = E.slice(0, s).map(f).join(",");
            return s === 0 ? U("0u", N) : s === 1 ? U(se[0], N) : (m.set = true, m.setByIndices = true, m.indicesToOffset = true, `set_${e}(${se}, ${N})`);
          }, setByOffset: U, setByIndices: (E, N) => s < 2 ? U(E, N) : (m.setByIndices = true, m.indicesToOffset = true, `set_${e}ByIndices(${E}, ${N});`), get: V, getByOffset: Q, getByIndices: W, usage: r, name: e, strides: y, shape: b, rank: s };
...
`);
      ...
      var pd, Co, md, fd, hd, gd, pe, Ao, Eo, Ve = k(() => {
        "use strict";
        L();
        F();
        ie();
  ...
  ${b.mainStart([h, h, 1])}
    ...
    if (output_row < uniforms.output_shape[0] && output_col < uniforms.output_shape[1]) {
      ${g.setByIndices(`${g.type.indices}(output_row, output_col)`, "tile[local_id.x][local_id.y]")}
              ...
              let b = x.size(i);
              return { outputs: [{ dims: i, dataType: e.dataType }], dispatchGroup: { x: Math.ceil(a[1] / h), y: Math.ceil(a[0] / h) }, programUniforms: [{ type: 12, data: b }, ...P(s, a)] };
            }, getShaderSource: d };
          }
          return d = (h) => {
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset("global_idx", b.getByIndices("aIndices"))}
          ...
          pd(e.inputs, t.perm), e.compute(pe(e.inputs[0], t.perm));
        }, Eo = (e) => G({ perm: e.perm });
      });
      var yd, bd, _d, wd, $d, vd, xd, Sd, Td, Id, ze, ko, Po, zo, Bo, Do, Oo, Mo, Uo, Ro, Vo, No = k(() => {
        "use strict";
        L();
        F();
        j();
       ...
       `, m = (h) => `
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ...
          d.length > 0 && (u = e.compute(pe(e.inputs[0], d), { inputs: [0], outputs: [-1] })[0], a = $d(a.length, u.dims.length));
      ...
      var Be, Cd, en, Kn, De, Ad, Ed, kd, Pd, zd, Bd, Dd, Od, Md, Ud, Oe, Lo, Go, Wo, Ho, qo, Fo, Ko, jo, Zo, Qo, Jt = k(() => {
        "use strict";
        L();
        F();
        ie();
        ...
        Be = (e) => {
          ...
          return { name: e, shaderCache: t, getShaderSource: (b) => {
            ...
            for (let $ = 0, T = 0; $ < l; $++) p || c.indexOf($) >= 0 ? (s && T++, v = `for(var j${$}: u32 = 0; j${$} < ${d[$]}; j${$}++) {
                  ...
                  ${v}
                }`) : (y.push(`${g.indicesSet("input_indices", $, _.indicesGet("output_indices", T))};`), T++);
            return `
...
`)}
          ...
          let n = [];
          return e[1].dims[0] > 0 && e[1].getBigInt64Array().forEach((r) => n.push(Number(r))), G({ axes: n, keepDims: t.keepDims, noopWithEmptyAxes: t.noopWithEmptyAxes });
        }, De = (e, t, n, r) => {
          ...
          Be(e.inputs), De(e, "ReduceLogSum", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += ${r.getByIndices("input_indices")};`, "value = log(value);"]);
        }, Ed = (e, t) => {
          Be(e.inputs), De(e, "ReduceL1", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += abs(${r.getByIndices("input_indices")});`, ""]);
        }, kd = (e, t) => {
          Be(e.inputs), De(e, "ReduceL2", t, (r, o) => [`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`, "", `t = ${r.getByIndices("input_indices")}; value += (t * t);`, "value = sqrt(value);"]);
        }, Pd = (e, t) => {
          Be(e.inputs), De(e, "ReduceLogSumExp", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += exp(${r.getByIndices("input_indices")});`, "value = log(value);"]);
        }, zd = (e, t) => {
          Be(e.inputs), De(e, "ReduceMax", t, (r, o, i) => {
            let s = [];
...
`)}`, `var value = ${r.getByIndices("input_indices")};`, `value = max(value, ${r.getByIndices("input_indices")});`, ""];
          ...
          Be(e.inputs), De(e, "ReduceMean", t, (r, o, i) => {
            let s = 1;
          ...
          Be(e.inputs), De(e, "ReduceMin", t, (r, o, i) => {
            let s = [];
...
`)}`, `var value = ${r.getByIndices("input_indices")};`, `value = min(value, ${r.getByIndices("input_indices")});`, ""];
          ...
          Be(e.inputs), De(e, "ReduceProd", t, (r, o) => [`var value = ${o.type.storage}(1);`, "", `value *= ${r.getByIndices("input_indices")};`, ""]);
        }, Md = (e, t) => {
          Be(e.inputs), De(e, "ReduceSum", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += ${r.getByIndices("input_indices")};`, ""]);
        }, Ud = (e, t) => {
          Be(e.inputs), De(e, "ReduceSumSquare", t, (r, o) => [`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`, "", `t = ${r.getByIndices("input_indices")}; value += t * t;`, ""]);
        }, Oe = (e, t, n) => {
          ...
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Bd(e, t) : ko(e, t);
        }, Go = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ed(e, t) : Po(e, t);
        }, Wo = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? kd(e, t) : zo(e, t);
        }, Ho = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Pd(e, t) : Bo(e, t);
        }, qo = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? zd(e, t) : Do(e, t);
        }, Fo = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Dd(e, t) : Oo(e, t);
        }, Ko = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Od(e, t) : Mo(e, t);
        }, jo = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Md(e, t) : Uo(e, t);
        }, Zo = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ud(e, t) : Ro(e, t);
        }, Qo = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ad(e, t) : Vo(e, t);
        };
      });
...
var best_index : i32 = 0;`, `if (${r.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? ">=" : ">"} value) {
      ...
      var Rd, Zn, Vd, Nd, Ld, it, Gd, ti, tn = k(() => {
        "use strict";
        L();
        F();
        Qt();
        ...
        Rd = (e, t) => {
          ...
          if (t.qkvHiddenSizes.length > 0) {
            ...
            for (let _ of t.qkvHiddenSizes) if (_ % t.numHeads !== 0) throw new Error("qkv_hidden_sizes should be divisible by num_heads");
          ...
          if (a) {
            ...
            if (a.dims[0] !== u || a.dims[1] !== t.numHeads || a.dims[2] !== d || a.dims[3] !== b) throw new Error('Expect "attention_bias" shape (batch_size, num_heads, sequence_length, total_sequence_length)');
          }
    ...
    `, Vd = (e, t, n, r, o, i, s, a) => {
          ...
          l < d && (d = 32);
          let c = Math.ceil(i / u / d), p = [{ type: 12, data: t }, { type: 12, data: n }, { type: 12, data: r }, { type: 12, data: o }, { type: 12, data: l }, { type: 12, data: c }], f = re(e.dataType, u), m = ce(1, u), h = ["type"];
          ...
          let b = (y) => {
            ...
            v && _.push(v);
            let $ = ce(e.dataType), T = [{ name: "batch_size", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "sequence_length", type: "u32" }, { name: "total_sequence_length", type: "u32" }, { name: "elements_per_thread", type: "u32" }];
            return `
    ...
    if (sum == 0) {
      ...
      ${s ? `
        for (var total_seq_id: u32 = seq_causal_length; total_seq_id + local_offset < uniforms.total_sequence_length; total_seq_id++) {
          ...
          return { name: "AttentionProbsSoftmax", shaderCache: { hint: `${d};${f};${u}`, inputDependencies: h }, getShaderSource: b, getRunData: () => ({ outputs: [], dispatchGroup: { x: 1, y: o, z: t * n }, programUniforms: p }) };
          ...
          let I = (A) => {
            let z = S("q", t.dataType, t.dims, b), R = S("key", n.dataType, n.dims, b), D = [z, R];
            if (v) {
              let H = S("past_key", r.dataType, r.dims, b);
              D.push(H);
            }
            o && D.push(S("attention_bias", o.dataType, o.dims));
            let U = a ? S("seq_lens", a.dataType, a.dims) : void 0;
            U && D.push(U);
            let Q = u ? S("total_sequence_length_input", u.dataType, u.dims) : void 0;
            Q && D.push(Q);
            let O = C("output", t.dataType, l), M = [O];
            c && M.push(C("present_key", t.dataType, f, b));
            let V = ce(1, b), W = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
            return `
  const TILE_SIZE = ${g}u;

  var<workgroup> tileQ: array<${z.type.storage}, ${g * g}>;
  var<workgroup> tileK: array<${z.type.storage}, ${g * g}>;
  ${A.registerUniforms(W).declareVariables(...D, ...M)}
  ${A.mainStart([g, g, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
        ...
        output[outputIdx] = ${O.type.value} (sum * uniforms.alpha) + ${o ? "attention_bias[outputIdx]" : "0.0"};
          ...
          return { name: "AttentionProbs", shaderCache: { hint: `${b};${o !== void 0};${r !== void 0};${e}`, inputDependencies: $ }, getRunData: () => ({ outputs: T, dispatchGroup: _, programUniforms: w }), getShaderSource: I };
        }, Ld = (e, t, n, r, o, i, s = void 0, a = void 0) => {
          ...
          let v = ($) => {
            ...
            s && A.push(z);
            let R = a ? S("total_sequence_length_input", a.dataType, a.dims) : void 0;
            a && A.push(R);
            let U = [C("output", t.dataType, m)];
            c && U.push(C("present_value", t.dataType, f));
            let Q = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "v_hidden_size", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
            return `
  const TILE_SIZE = ${h}u;
  ...
  ${$.mainStart([h, h, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
          ...
          let p = Math.min(e.outputCount, 1 + (s ? 1 : 0) + (a ? 1 : 0)), f = p > 1 ? d.pastSequenceLength : 0, m = f + d.kvSequenceLength, h = u && x.size(u.dims) > 0 ? u : void 0, b = [t, n];
          p > 1 && s && x.size(s.dims) > 0 && b.push(s), h && b.push(h), l && b.push(l), c && b.push(c);
          let y = e.compute(Nd(p, t, n, s, h, d, f, l, c), { inputs: b, outputs: p > 1 ? [-1, 1] : [-1] })[0];
          e.compute(Vd(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c), { inputs: l && c ? [y, l, c] : [y], outputs: [] });
          let g = [y, r];
          p > 1 && a && x.size(a.dims) > 0 && g.push(a), l && g.push(l), c && g.push(c), e.compute(Ld(p, y, r, a, d, f, l, c), { inputs: g, outputs: p > 1 ? [0, 2] : [0] });
        }, Gd = (e, t) => {
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      var Wd, Hd, qd, ni, ri = k(() => {
        ...
        Wd = (e, t) => {
          ...
          let { epsilon: n, spatial: r, format: o } = t, i = e[0].dims, s = r ? J(i[i.length - 1]) : 1, a = o === "NHWC" && i.length > 1 ? s : 1, u = x.size(i) / s, d = r, l = d ? i.length : i, c = S("x", e[0].dataType, e[0].dims, s), p = S("scale", e[1].dataType, e[1].dims, a), f = S("bias", e[2].dataType, e[2].dims, a), m = S("inputMean", e[3].dataType, e[3].dims, a), h = S("inputVar", e[4].dataType, e[4].dims, a), b = C("y", e[0].dataType, l, s), y = () => {
            let _ = "";
            if (r) _ = `let cOffset = ${i.length === 1 ? "0u" : o === "NHWC" ? `outputIndices[${i.length - 1}] / ${s}` : "outputIndices[1]"};`;
            else if (o === "NCHW") _ = `
  ...
  ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${b.setByOffset("global_idx", "value")}
          ...
          let { inputs: n, outputCount: r } = e, o = qd({ ...t, outputCount: r });
          if (te.webgpu.validateInputContent && Wd(n, o), t.trainingMode) throw new Error("BatchNormalization trainingMode is not supported yet.");
          e.compute(Hd(n, o));
        };
      });
      var Fd, Kd, oi, ii = k(() => {
  ...
  ${l.mainStart()}
    ...
    ${u.setByOffset("global_idx", "value")}
          ...
          Fd(e.inputs), e.compute(Kd(e.inputs));
        };
      });
      var jd, ee, si, ai, ui, di, li, ci, pi, mi, fi, Zd, hi, gi, yi, bi, yt, _i, nn, wi, $i, vi, xi, Si, Ti, Ii, Ci, Ai, Ei, ki, Pi, zi, Bi, Di, Oi, Mi, Ui, Qn, Xn, Ri, Vi, Ni, Qd, Xd, Li, rn = k(() => {
        "use strict";
        L();
        F();
        ie();
  ...
  ${e.mainStart()}
    ...
    ${l.setByOffset("global_idx", u)}
          ...
          return G({ min: t, max: n });
        }, hi = (e, t) => {
          let n = t || Zd(e.inputs), r = ce(e.inputs[0].dataType);
...
`, Xd = (e) => `quick_gelu_impl(${e})`, Li = (e, t) => {
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
      ...
      var el, tl, Me, qi, Fi, Ki, ji, Zi, Qi, Xi, Yi, Ji, es, ts = k(() => {
        "use strict";
        L();
        F();
        j();
        el = (e, t, n, r, o, i, s, a, u, d, l, c) => {
          ...
          if (o) if (i) {
            let g = x.size(t) === 1, _ = x.size(n) === 1, w = t.length > 0 && t[t.length - 1] % 4 === 0, v = n.length > 0 && n[n.length - 1] % 4 === 0;
          ...
          `;
          } else y = m.setByOffset("global_idx", f(h.getByOffset("global_idx"), b.getByOffset("global_idx")));
          else {
        ...
        ${y}
          ...
          if (d) {
            let h = Pe.calcShape(a, u, false);
            if (!h) throw new Error("Can't perform binary op on the given tensors");
            l = h.slice(), c = x.size(l);
            let b = x.size(a) === 1, y = x.size(u) === 1, g = a.length > 0 && a[a.length - 1] % 4 === 0, _ = u.length > 0 && u[u.length - 1] % 4 === 0;
          ...
          Me(e, "Equal", { scalar: (t, n) => `u32(${t}==${n})`, vector: (t, n) => `vec4<u32>(${t}==${n})` }, void 0, void 0, 9);
        }, ji = (e) => {
          Me(e, "Mul", (t, n) => `${t}*${n}`);
        }, Zi = (e) => {
          let t = S("input", e.inputs[0].dataType, e.inputs[0].dims).type.value;
          Me(e, "Pow", { scalar: (r, o) => `pow_custom(${r},${o})`, vector: (r, o) => `pow_vector_custom(${r},${o})` }, `
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `);
          ...
          Me(e, "Greater", { scalar: (t, n) => `u32(${t}>${n})`, vector: (t, n) => `vec4<u32>(${t}>${n})` }, void 0, void 0, 9);
        }, Yi = (e) => {
          Me(e, "Less", { scalar: (t, n) => `u32(${t}<${n})`, vector: (t, n) => `vec4<u32>(${t}<${n})` }, void 0, void 0, 9);
        }, Ji = (e) => {
          Me(e, "GreaterOrEqual", { scalar: (t, n) => `u32(${t}>=${n})`, vector: (t, n) => `vec4<u32>(${t}>=${n})` }, void 0, void 0, 9);
        }, es = (e) => {
          Me(e, "LessOrEqual", { scalar: (t, n) => `u32(${t}<=${n})`, vector: (t, n) => `vec4<u32>(${t}<=${n})` }, void 0, void 0, 9);
        };
      });
...
`;
          ...
          let s = e[0].dims, a = e[1].dims, u = s[s.length - 2], d = a[a.length - 1], l = s[s.length - 1], c = J(d), p = J(l), f = J(u), m = x.size(n) / c / f, h = e.length > 2, b = r ? r.slice(0, -2) : n.slice(0, -2), g = [x.size(b), u, d], _ = [{ type: 12, data: m }, { type: 12, data: u }, { type: 12, data: d }, { type: 12, data: l }];
          Ce(t, _), _.push(...P(b, s, a)), h && _.push(...P(e[2].dims)), _.push(...P(g));
          let w = (v) => {
            let $ = Yt("batch_dims", e[0].dataType, b.length), T = S("a", e[0].dataType, s.length, p), I = S("b", e[1].dataType, a.length, c), A = C("output", e[0].dataType, g.length, c), z = re(A.type.tensor), R = Ie(t, A.type.value, z), D = [T, I], U = "";
            if (h) {
              let M = o ? c : 1;
              D.push(S("bias", e[2].dataType, e[2].dims.length, M)), U = `${o ? `value += bias[col / ${M}];` : `value += ${A.type.value}(bias[row + i]);`}`;
            }
            let Q = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }];
            Ae(t, Q);
            let O = () => {
              let M = `var a_data: ${T.type.value};`;
              for (let V = 0; V < p; V++) M += `
              let b_data${V} = b[(b_offset + (k + ${V}) * uniforms.N + col) / ${c}];`;
              for (let V = 0; V < f; V++) {
                M += `a_data = a[(a_offset + (row + ${V}) * uniforms.K + k) / ${p}];`;
                for (let W = 0; W < p; W++) M += `
            values[${V}] = fma(${I.type.value}(a_data${p === 1 ? "" : `[${W}]`}), b_data${W}, values[${V}]);
`;
              }
              return M;
            };
  ...
  `;
      ...
      var al, ul, Yn, us, dl, Jn, ll, _t, dn = k(() => {
        "use strict";
        L();
        F();
        j();
...
`;
    ...
    `;
        }, _t = (e, t, n, r, o = false, i) => {
          let s = e[0].dims, a = e[1].dims, u = s.slice(0, -2), d = a.slice(0, -2), l = r ? r.slice(0, -2) : n.slice(0, -2), c = x.size(l), p = s[s.length - 2], f = s[s.length - 1], m = a[a.length - 1], h = f % 4 === 0 && m % 4 === 0, b = p <= 8 ? [4, 1, 1] : [4, 4, 1], y = [8, 8, 1], g = [Math.ceil(m / y[0] / b[0]), Math.ceil(p / y[1] / b[1]), Math.ceil(c / y[2] / b[2])], _ = h ? 4 : 1, w = [...u, p, f / _], v = w.length, $ = [...d, f, m / _], T = $.length, I = [c, p, m / _], A = [{ type: 6, data: p }, { type: 6, data: m }, { type: 6, data: f }];
          Ce(t, A), A.push(...P(l, w, $));
          let z = ["rank", "rank"], R = e.length > 2;
          R && (A.push(...P(e[2].dims)), z.push("rank")), A.push(...P(I));
          let D = (U) => {
            let Q = l.length, O = Yt("batchDims", e[0].dataType, Q, 1), M = re(e[0].dataType), V = S("a", e[0].dataType, v, _), W = S("b", e[1].dataType, T, _), H = C("result", e[0].dataType, I.length, _), X = [V, W];
            if (R) {
              let N = o ? _ : 1;
              X.push(S("bias", e[2].dataType, e[2].dims.length, N));
            }
            let oe = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }];
            Ae(t, oe);
            let de = re(H.type.tensor), q = Ie(t, H.type.value, de), E = ll(_, R, q, [O, V, W, H], o);
            return `
  ...
  ${h ? Yn(b, y, M, O) : Jn(b, y, M, O)}
          ...
          return { name: "MatMul", shaderCache: { hint: `${b};${t.activation};${h};${o}`, inputDependencies: z }, getRunData: () => ({ outputs: [{ dims: i ? i(n) : n, dataType: e[0].dataType }], dispatchGroup: { x: g[0], y: g[1], z: g[2] }, programUniforms: A }), getShaderSource: D };
        };
      });
      var cl, ds, ls = k(() => {
        "use strict";
    ...
    return ${ue(a, d)}(0.0);`, v = ue(u, d), $ = e ? ue(s, d) : ue(a, d), T = e ? ue(a, d) : ue(s, d), I = Ie(i, v, d);
          return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
          ...
          let v = h ? d && l % 4 !== 0 ? 3 : 4 : 1, $ = g[1] * _[1], T = g[0] * _[0], I = Math.max(g[0] * v, g[1]), A = r % $ === 0, z = o % T === 0, R = i % I === 0, D = h ? [v, 4, 4] : [1, 1, 1], U = [{ type: 6, data: r }, { type: 6, data: o }, { type: 6, data: i }, { type: 6, data: [t.pads[0], t.pads[1]] }, { type: 6, data: t.strides }, { type: 6, data: t.dilations }];
          Ce(t, U), U.push(...P(e[0].dims, e[1].dims));
          let Q = ["rank", "rank"];
          s && (U.push(...P(e[2].dims)), Q.push("rank")), U.push(...P(n));
          let O = (M) => {
            let V = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }, { name: "pad", type: "i32", length: 2 }, { name: "stride", type: "i32", length: 2 }, { name: "dilation", type: "i32", length: 2 }];
            Ae(t, V);
            let W = h ? 4 : 1, H = re(e[0].dataType), X = `
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${H}>` : H}) {
      ...
      }`, oe = S("x", e[0].dataType, e[0].dims.length, v === 3 ? 1 : v), de = S("w", e[1].dataType, e[1].dims.length, W), q = [oe, de], E = C("result", e[0].dataType, n.length, W);
            if (s) {
              let N = S("bias", e[2].dataType, e[2].dims.length, W);
              q.push(N), X += `
        ...
        ${h ? Yn(_, g, H, void 0, !d, I) : Jn(_, g, H, void 0, !d, I, false, void 0, a)}`;
          };
          return { name: "Conv2DMatMul", shaderCache: { hint: `${t.cacheKey};${v};${h};${A};${z};${R};${$};${T};${I}`, inputDependencies: Q }, getRunData: () => ({ outputs: [{ dims: u ? u(n) : n, dataType: e[0].dataType }], dispatchGroup: { x: w[0], y: w[1], z: w[2] }, programUniforms: U }), getShaderSource: O };
        };
      });
      var pl, cs, ln, ml, ps, fl, ms, fs, hs = k(() => {
        ...
        pl = (e) => {
          ...
          if (e === "VALID" && (e = 0), typeof e == "number") {
            ...
            if (!e.every((h, b, y) => h === y[0])) throw Error(`Unsupported padding parameter: ${e}`);
            ...
            let m = (c - 1) * o + a - t, h = (p - 1) * i + u - n, b = (f - 1) * s + d - r, y = Math.floor(m / 2), g = m - y, _ = Math.floor(h / 2), w = h - _, v = Math.floor(b / 2), $ = b - v;
          ...
          let [p, , f, m, h] = t, [b, y, g] = cs(n), [_, w, v] = cs(r), $ = ln(f, _), T = ln(m, w), I = ln(h, v), { padInfo: A, outDepth: z, outHeight: R, outWidth: D } = fl(o, u, d, l, b, y, g, $, T, I), U = i ? p * c : p, Q = [0, 0, 0, 0, 0];
          return s === "channelsFirst" ? Q = [a, U, z, R, D] : s === "channelsLast" && (Q = [a, z, R, D, U]), { batchSize: a, dataFormat: s, inDepth: u, inHeight: d, inWidth: l, inChannels: c, outDepth: z, outHeight: R, outWidth: D, outChannels: U, padInfo: A, strideDepth: b, strideHeight: y, strideWidth: g, filterDepth: f, filterHeight: m, filterWidth: h, effectiveFilterDepth: $, effectiveFilterHeight: T, effectiveFilterWidth: I, dilationDepth: _, dilationHeight: w, dilationWidth: v, inShape: e, outShape: Q, filterShape: t };
        }, fs = (e, t, n, r, o, i) => {
          let s = i === "channelsLast", a = s ? e[0].dims[3] : e[0].dims[1], u = false, d = [64, 1, 1], l = { x: n.map((g, _) => _) }, c = [Math.ceil(pl(l.x.map((g) => n[g])) / d[0]), 1, 1];
          ...
          let y = (g) => {
            ...
            Ae(t, _);
            let w = u ? 4 : 1, v = re(e[0].dataType), $ = S("x", e[0].dataType, e[0].dims.length, p === 3 ? 1 : p), T = S("W", e[1].dataType, e[1].dims.length, w), I = [$, T], A = C("result", e[0].dataType, n.length, w), z = "";
            if (b) {
              let U = S("bias", e[2].dataType, e[2].dims.length, w);
              I.push(U), z += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u ? `vec4<${v}>` : v} {
          return bias[${s ? B("coords", 4, 5) : B("coords", 1, 5)}${u ? "/ 4" : ""}];
        }`;
            }
            let R = ue(p, v), D = Ie(t, R, v);
            return `
            ${z}
      ...
      var gs, ys, bs = k(() => {
        ...
        gs = (e, t, n, r) => {
          ...
          let h = (b) => {
            let y = C("output", e[0].dataType, n.length, c), g = re(y.type.tensor), _ = Ie(t, y.type.value, g), w = S("x", e[0].dataType, s.length), v = S("w", e[1].dataType, a.length, c), $ = [w, v];
  ...
  ${b.mainStart()}
    ...
    ${y.setByOffset("global_idx", "value")}
          ...
          let p = (s - 1) * t.strides[1] + d[1], f = (m) => {
            let h = C("output", e[0].dataType, l.length, i), b = re(h.type.tensor), y = Ie(t, h.type.value, b), g = S("x", e[0].dataType, u.length, i), _ = S("w", e[1].dataType, d.length, i), w = [g, _];
  ...
  ${m.mainStart()}
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      var hl, er, gl, tr, nr, _s, yl, bl, rr, ws = k(() => {
        ...
        hl = (e, t, n, r, o, i) => {
          ...
          if (n.group !== 1) {
            let $ = [t[0]];
            if (o) {
              let I = e.kernelCustomData.wT ?? e.compute(pe(t[1], er), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
          ...
          if (h || l === 1 && c === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 && n.strides[0] === 1 && n.strides[1] === 1 && n.pads[0] === 0 && n.pads[1] === 0) {
            let $ = i[0], T, I, A, z = [];
            if (o) {
              let U = e.kernelCustomData.wT ?? e.compute(pe(t[1], er), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
              if (n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = U), h) {
                let Q = a * u * d;
                T = t[0].reshape([1, $, Q]), I = U.reshape([1, Q, m]), A = [1, $, m];
              } else T = t[0].reshape([$, a * u, d]), I = U.reshape([1, d, m]), A = [$, p * f, m];
              z.push(T), z.push(I);
            } else T = t[0].reshape([$, d, a * u]), I = t[1].reshape([1, m, d]), A = [$, m, p * f], z.push(I), z.push(T);
            s && z.push(t[2]);
            let R = A[2], D = z[0].dims[z[0].dims.length - 1];
            R < 8 && D < 8 ? e.compute(an(z, n, i, A, o, r), { inputs: z }) : e.compute(_t(z, n, i, A, o, r), { inputs: z });
            return;
          }
          let b = true, y = e.kernelCustomData.wT ?? e.compute(pe(t[1], er), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
          n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = y);
          let g = [t[0], y];
          s && g.push(t[2]);
          let _ = o ? p * f : m, w = o ? m : p * f, v = l * c * d;
          e.compute(ds(g, n, i, _, w, v, s, b, r), { inputs: g });
        }, yl = (e, t) => {
          ...
          if (gl(e.inputs, t), e.inputs[0].dims.length === 3) yl(e, t);
          else if (e.inputs[0].dims.length === 5) bl(e, e.inputs, t);
          else {
            let n = tr(t, e.inputs);
            _s(e, e.inputs, n);
          }
      ...
      var $s, vs = k(() => {
        ...
        j();
        $s = (e, t, n) => {
          let r = e.length > 2, o = t.outputShape, i = t.format === "NHWC", s = t.group, a = e[1].dims, u = a[2] / s, d = a[3], l = i ? J(u) : 1, c = i && d === 1 && u >= 4, p = c ? Math.floor(u / 4) * 4 : Math.floor(u / l) * l, f = u - p, m = i ? J(d) : 1, h = i ? d === 1 ? l : m : 1, b = x.size(o) / m, y = [Math.ceil(b / 64), 1, 1];
          Z("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${y}`);
          let g = ["rank", "rank"], _ = [t.strides[0], t.strides[1]], w = [t.kernelShape[i ? 1 : 2], t.kernelShape[i ? 2 : 3]], v = [t.dilations[0], t.dilations[1]], $ = [w[0] + (t.dilations[0] <= 1 ? 0 : (t.kernelShape[i ? 1 : 2] - 1) * (t.dilations[0] - 1)), w[1] + (t.dilations[1] <= 1 ? 0 : (t.kernelShape[i ? 2 : 3] - 1) * (t.dilations[1] - 1))], T = [$[0] - 1 - Math.floor((t.pads[0] + t.pads[2]) / 2), $[1] - 1 - Math.floor((t.pads[1] + t.pads[3]) / 2)], I = [{ type: 12, data: b }, { type: 12, data: _ }, { type: 12, data: w }, { type: 12, data: v }, { type: 12, data: $ }, { type: 6, data: T }, { type: 12, data: p }, { type: 12, data: u }, { type: 12, data: d }, ...P(e[0].dims, e[1].dims)];
          r && (I.push(...P(e[2].dims)), g.push("rank")), I.push(...P(o));
          let A = (z) => {
            let R = [{ name: "output_size", type: "u32" }, { name: "strides", type: "u32", length: _.length }, { name: "filter_dims", type: "u32", length: w.length }, { name: "dilations", type: "u32", length: w.length }, { name: "effective_filter_dims", type: "u32", length: $.length }, { name: "pads", type: "i32", length: T.length }, { name: "input_channels_per_group_int", type: "u32" }, { name: "input_channels_per_group", type: "u32" }, { name: "output_channels_per_group", type: "u32" }], D = re(e[0].dataType), U = i ? 1 : 2, Q = i ? 2 : 3, O = i ? 3 : 1, M = S("W", e[1].dataType, e[1].dims.length, h), V = S("Dy", e[0].dataType, e[0].dims.length, l), W = [V, M];
            r && W.push(S("bias", e[2].dataType, [o[O]].length, m));
            let H = C("result", e[0].dataType, o.length, m), X = () => {
              let q = "";
              if (c) l === 4 ? q += `
        ...
        `, l === 1) q += `
          ...
          dotProd = dotProd + xValue * wValue;`;
            ...
            dotProd = dotProd + xValue[${E}] * wValue${E};`;
              ...
              if (l === 1) {
                q += "dotProd = dotProd";
                for (let E = 0; E < f; E++) q += `
            + ${V.getByOffset(`x_offset + ${E}`)} * ${M.getByOffset(`w_offset + ${E}`)}`;
                q += ";";
              } else if (l === 2) {
          ...
          `;
            return `
    ${z.registerUniforms(R).declareVariables(...W, H)}
      ${z.mainStart()}
      ${z.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")};
    ${de}}`;
          };
          return { name: "ConvTranspose2D", shaderCache: { hint: `${t.cacheKey};${l}${h}${m}${c}${f}`, inputDependencies: g }, getRunData: () => ({ dispatchGroup: { x: y[0], y: y[1], z: y[2] }, outputs: [{ dims: n ? n(o) : o, dataType: e[0].dataType }], programUniforms: I }), getShaderSource: A };
        };
      });
      var _l, wl, $l, xs, Ss, vl, Ts, xl, Is, Cs = k(() => {
        ...
        _l = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i, wl = (e, t, n, r, o) => {
          ...
          for (let m = 0, h = e.length - l - (a ? 1 : 0); m < l; ++m, ++h) {
            let b = e[h], y = c ? b * s[m] : d[m], g = _l(b, s[m], i[m], t[h], n[m], y);
            wl(g, r, i, m, m + l), c && d.push(s[m] * (b - 1) + u[m] + (t[h] - 1) * n[m] + 1 - i[m] - i[m + l]);
          }
          ...
          if (vl(e.inputs, t), e.inputs[0].dims.length === 3) xl(e, t);
          else {
            let n = xs(t, e.inputs);
            Ts(e, e.inputs, n);
          }
      ...
      var Sl, As, Es, ks = k(() => {
        ...
        Sl = (e, t, n, r) => {
          ...
          return G({ exclusive: t, reverse: n });
        };
      });
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset("global_idx", m.getByIndices("aIndices"))}
          ...
          return { name: "DepthToSpace", shaderCache: { hint: `${e.dims};${t.blocksize};${t.mode}`, inputDependencies: ["rank"] }, getRunData: (y) => {
            let g = u ? [n, r * d, o * d, i / d ** 2] : [n, i / d ** 2, r * d, o * d], _ = x.size(g), w = c.dims, v = x.sortBasedOnPerm(w, a);
            return { outputs: [{ dims: g, dataType: y[0].dataType }], dispatchGroup: { x: Math.ceil(_ / 64) }, programUniforms: [{ type: 12, data: _ }, ...P(w, v)] };
          }, getShaderSource: b };
        }, Ps = (e, t) => {
          Tl(e.inputs), e.compute(Cl(e.inputs[0], t));
        }, zs = (e) => G({ blocksize: e.blocksize, mode: e.mode, format: e.format });
      });
      var or, cn, Ds, Al, El, ir, sr, Os, kl, Ms, Us, Rs = k(() => {
        ...
        or = "[a-zA-Z]|\\.\\.\\.", cn = "(" + or + ")+", Ds = "^" + cn + "$", Al = "(" + cn + ",)*" + cn, El = "^" + Al + "$", ir = class {
          ...
          constructor(t, n) {
            ...
            if (!r.match(RegExp(El))) throw new Error("Invalid LHS term");
          ...
          let i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)), s = x.size(r), a = C("output", t, r.length), u = [...n.symbolToInfo.keys()].filter((l) => !n.rhs.symbolToIndices.has(l)), d = (l) => {
            ...
            n.symbolToInfo.forEach((v, $) => {
              if (n.rhs.symbolToIndices.has($)) {
                ...
                T !== void 0 && n.lhs.forEach((I, A) => {
                  if (v.inputIndices.includes(A)) {
                    ...
                    z.forEach((R) => {
                      c.push(`${i[A].indicesSet(`input${A}Indices`, R, a.indicesGet("outputIndices", T))}`);
                    });
                  }
                });
              ...
              }), b.push(`for(var ${$}: u32 = 0; ${$} < uniforms.${Os($)}; ${$}++) {`), y.push("}");
            });
            let w = _ ? [...c, `let sum = ${i.map((v, $) => v.getByIndices(`input${$}Indices`)).join(" * ")};`] : [...c, f, ...b, ...h, p, ...g, m, ...y];
            return `
...
`)};
    ...
    ${s.mainStart(Je)}
      ...
      var Ol, Ml, Hs, qs, Fs = k(() => {
        ...
        Ol = (e) => {
          ...
          let a = n[i], u = e[0].dataType === 9 ? 4 : 1, d = Math.ceil(x.size(s) / u), l = [{ type: 12, data: d }, { type: 6, data: a }, { type: 12, data: i }, ...P(e[0].dims, e[1].dims, s)], c = (p) => {
            let f = S("data", e[0].dataType, e[0].dims.length, u), m = S("inputIndices", e[1].dataType, e[1].dims.length), h = C("output", e[0].dataType, s.length, u), b = (g) => {
              ...
              for (let v = 0; v < _; v++) w += `${_ > 1 ? `indicesIndices${g}[${v}]` : `indicesIndices${g}`} = ${s.length > 1 ? `outputIndices${g}[uniforms.axis + ${v}]` : `outputIndices${g}`};`;
              w += `
        ...
        `;
              for (let v = 0, $ = 0; v < o; v++) v === i ? (w += `${o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`} = u32(idx${g});`, $ += _) : (w += `${o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`} = ${s.length > 1 ? `outputIndices${g}[${$}]` : `outputIndices${g}`};`, $++);
              return w;
            }, y;
            if (e[0].dataType === 9) {
              let g = (_, w, v = "") => `
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
          ...
          let b = i.slice(0, -1).concat(r.slice(h)), y = x.size(b), g = [{ type: 12, data: y }, { type: 12, data: u }, ...P(n[0].dims, m.dims, b)], _ = (w) => {
            let v = S("data", n[0].dataType, n[0].dims.length), $ = S("slice_offsets", 12, m.dims.length), T = C("output", n[0].dataType, b.length);
            return `
      ...
      var Rl, Vl, Qs, Xs, Ys = k(() => {
        ...
        Rl = (e, t) => {
          ...
          let n = x.normalizeAxis(t.quantizeAxis, e[0].dims.length), r = t.blockSize, o = e[0], i = e[2], s = e.length === 4 ? e[3] : void 0;
        ...
        }, Xs = (e) => G({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis });
      });
      ...
      ${f.setByOffset("global_idx", "value")};
        ...
        }, Js = (e) => G({ axis: e.axis }), ea = (e, t) => {
          let n = e.inputs;
          Nl(n), e.compute(Ll(e.inputs, t));
        };
      });
      var Gl, Wl, na, ra, oa = k(() => {
        "use strict";
        L();
        F();
        j();
        Gl = (e) => {
          ...
          let h = (y) => {
            ...
            let _ = t.alpha === 1 ? "" : "value *= uniforms.alpha;", w = S("a", e[0].dataType, e[0].dims), v = S("b", e[1].dataType, e[1].dims), $ = w.type.value, T = null, I = [w, v];
  ...
  ${y.mainStart([u, u, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
          ...
          Gl(e.inputs), e.compute(Wl(e.inputs, t));
        };
      });
      var Ne, Ke, st, at, Hl, ql, Fl, Kl, jl, Zl, Ql, Xl, ia, sa, aa = k(() => {
        "use strict";
        L();
        F();
        ie();
        j();
        [Ne, Ke, st, at] = [0, 1, 2, 3], Hl = (e) => {
...
`, Ql = (e, t, n) => (() => {
        ...
        `;
          ...
          t.format === "NHWC" && (i = [e[0].dims[0], e[1].dims[1], e[1].dims[2], e[0].dims[3]], [Ne, Ke, st, at] = [0, 3, 1, 2]);
  ...
  ${c.mainStart()}
    ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Ql(s, a, t)}
        ...
        }, sa = (e) => G({ alignCorners: e.align_corners, mode: e.mode, paddingMode: e.padding_mode, format: e.format });
      });
      var be, ec, da, ua, tc, wt, la, ar = k(() => {
        "use strict";
        L();
        F();
        ie();
        ...
        j();
        Ve();
        be = (e, t) => e.length > t && e[t].dims.length > 0 ? e[t] : void 0, ec = (e, t) => {
          ...
          if (u && d && x.size(u.dims) && x.size(d.dims)) {
            ...
            if (u.dims[0] !== l || u.dims[1] !== t.numHeads || u.dims[3] !== b) throw new Error('Input "past_key" shape (batch_size, num_heads, past_sequence_length, head_size)');
            if (d.dims[0] !== l || d.dims[1] !== t.numHeads || d.dims[3] !== b) throw new Error('Input "past_value" shape (batch_size, num_heads, past_sequence_length, head_size)');
          ...
          } else if (u && x.size(u.dims) || d && x.size(d.dims)) throw new Error('Input "past_key" and "past_value" shall be both present or both absent');
          let y;
          ...
          return { batchSize: l, sequenceLength: c, pastSequenceLength: m, kvSequenceLength: f, totalSequenceLength: g, maxSequenceLength: h, inputHiddenSize: 0, hiddenSize: p, vHiddenSize: v, headSize: b, vHeadSize: Math.floor(v / t.numHeads), numHeads: t.numHeads, isUnidirectional: false, pastPresentShareBuffer: false, maskFilterValue: t.maskFilterValue, maskType: _, scale: t.scale, broadcastResPosBias: $, passPastInKv: w, qkvFormat: y };
        }, da = (e) => G({ ...e }), ua = G({ perm: [0, 2, 1, 3] }), tc = (e, t, n, r, o, i, s) => {
  ...
  ${c.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
          ...
          if (s && x.size(s.dims) > 0) {
            ...
            return u = tc(e, i, s, t, r, n * o, a), u = u.reshape([t, r, n, o]), n === 1 || r === 1 ? u : e.compute(pe(u, ua.perm), { inputs: [u], outputs: [-1] })[0];
          } else return i.dims.length === 3 && (u = i.reshape([t, r, n, o])), n === 1 || r === 1 ? u : e.compute(pe(u, ua.perm), { inputs: [u], outputs: [-1] })[0];
        }, la = (e, t) => {
          let n = ec(e.inputs, t), r = e.inputs[0], o = be(e.inputs, 1), i = be(e.inputs, 2), s = be(e.inputs, 3), a = be(e.inputs, 4), u = be(e.inputs, 5), d = be(e.inputs, 6), l = be(e.inputs, 7);
          ...
          let c = o && i && o.dims.length === 4 && i.dims.length === 4, p = wt(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, r, s, 0);
          if (c) return it(e, p, o, i, a, void 0, d, l, u, n);
          if (!o || !i) throw new Error("key and value must be provided");
          let f = wt(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.headSize, o, s, n.hiddenSize), m = wt(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.vHeadSize, i, s, 2 * n.hiddenSize);
      ...
      var nc, rc, oc, ic, ur, ca, pa, dr = k(() => {
        ...
        nc = (e) => {
          ...
          return e[1].dims[0] > 0 && (e[1].getBigInt64Array().forEach((o) => n.push(Number(o))), r = n.length), G({ numOutputs: r, axis: t.axis, splitSizes: n });
        }, oc = (e) => `
...
`)}
  ...
  ${m.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
          ...
          return G({ axis: t, numOutputs: r, splitSizes: n });
        };
      });
      var sc, pn, ma, lr = k(() => {
        "use strict";
        ...
        sc = (e, t) => {
          ...
          if (!x.areEqual(r.dims, []) && !x.areEqual(r.dims, [1]) && r.dims.length !== 2) throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${r.dims.length}`);
          ...
          if (!x.areEqual(o.dims, i.dims)) throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");
          ...
          let { interleaved: n, numHeads: r, rotaryEmbeddingDim: o, scale: i } = t, s = e[0].dims[0], a = x.sizeFromDimension(e[0].dims, 1), u = e[0].dims[e[0].dims.length - 2], d = a / u, l = e[2].dims[1], c = o === 0 ? l * 2 : d / r, p = new Array(s, u, d / c, c - l), f = x.computeStrides(p), m = [{ type: 1, data: i }, { type: 12, data: p }, { type: 12, data: f }, ...e[0].dims.length === 3 ? new Array({ type: 12, data: [a, d, c, 1] }) : [], ...e[0].dims.length === 4 ? new Array({ type: 12, data: [a, c, u * c, 1] }) : [], ...P(e[0].dims, e[1].dims, e[2].dims, e[3].dims, e[0].dims)], h = (b) => {
        ...
        ${b.mainStart(Je)}
          ...
          return { name: "RotaryEmbedding", shaderCache: { hint: G({ interleaved: n }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: h, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(x.size(p) / Je) }, programUniforms: m }) };
        }, ma = (e, t) => {
      ...
      var ac, uc, fa, dc, ha, ga = k(() => {
        ...
        ac = (e, t) => {
          ...
          if (h && b) {
            ...
            p = i.dims[2];
          } else if (h || b) throw new Error('Input "past_key" and "past_value" shall be both present or both absent');
          let g = 1;
          ...
          if ($ && $.dims.length !== 1 && $.dims[0] !== u) throw new Error('Input "seqlens" is expected to have 1 dimension and the same dim 0 as batch_size');
        ...
        }, uc = G({ perm: [0, 2, 1, 3] }), fa = (e, t, n) => {
          let r = t, o = n.kvNumHeads;
          return t.dims.length === 3 && n.kvSequenceLength !== 0 && (r = t.reshape([n.batchSize, n.kvSequenceLength, o, n.headSize]), r = e.compute(pe(r, uc.perm), { inputs: [r], outputs: [-1] })[0]), r;
        }, dc = (e, t, n, r) => {
  ...
  `;
          ...
          let r = e.inputs[0], o = e.inputs[1] && e.inputs[1].dims.length > 0 ? e.inputs[1] : void 0, i = e.inputs[2] && e.inputs[2].dims.length > 0 ? e.inputs[2] : void 0, s = e.inputs[3] && e.inputs[3].dims.length !== 0 ? e.inputs[3] : void 0, a = e.inputs[4] && e.inputs[4].dims.length !== 0 ? e.inputs[4] : void 0, u = e.inputs.length > 4 ? e.inputs[5] : void 0, d = e.inputs.length > 5 ? e.inputs[6] : void 0, l = n.kvNumHeads ? n.kvNumHeads : n.numHeads, c = G({ axis: 2, numOutputs: 3, splitSizes: [n.numHeads * n.headSize, l * n.headSize, l * n.headSize] }), [p, f, m] = !o && !i ? e.compute(ur([r], c), { inputs: [r], outputs: [-1, -1, -1] }) : [r, o, i], h, b;
          if (t.doRotary) {
            let w = e.compute(dc(n.batchSize, n.sequenceLength, u, d), { inputs: [u, d], outputs: [-1] })[0], v = e.inputs[7], $ = e.inputs[8], T = G({ interleaved: t.rotaryInterleaved !== 0, numHeads: n.numHeads, rotaryEmbeddingDim: 0, scale: t.scale }), I = [p, w, v, $], A = [-1];
            h = e.compute(pn(I, T), { inputs: I, outputs: A })[0], I.splice(0, 1, f);
            let z = G({ interleaved: t.rotaryInterleaved !== 0, numHeads: n.kvNumHeads, rotaryEmbeddingDim: 0, scale: t.scale });
            b = e.compute(pn(I, z), { inputs: I, outputs: A })[0];
          }
          let y = wt(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, t.doRotary ? h : p, void 0, 0), g = fa(e, t.doRotary ? b : f, n), _ = fa(e, m, n);
          it(e, y, g, _, void 0, void 0, s, a, void 0, n, u, d);
        };
      });
      var ya, lc, cc, ba, _a = k(() => {
        ...
        ya = (e, t, n, r, o, i, s, a) => {
          ...
          b.push(...P(f, m));
          let y = (g) => {
            let _ = S("x", t.dataType, 3, u), w = S("scale", n.dataType, n.dims), v = S("bias", r.dataType, r.dims), $ = C("output", 1, 3, 2), T = [_, w, v, $];
            return `
  ...
  ${g.mainStart(p)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
          ...
          let r = t[0].dims, o = r, i = 2, s = r[0], a = r[1], u = x.sizeFromDimension(r, i), d = J(u), l = x.size(o) / d, c = ya(e, t[0], t[1], t[2], s, u, a, n.epsilon), p = [s, a, u / d], f = [s, a], m = ["type", "none"], h = (b) => {
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${_.setByOffset("global_idx", "value")};
          ...
          p = p && r[r.length - 1] !== 1;
          let m = p ? e.compute(pe(e.inputs[0], f), { inputs: [e.inputs[0]], outputs: [-1] })[0] : e.inputs[0].reshape(Array.from({ length: r.length }, (y, g) => r[f[g]])), h = ya(e, m, t[1], t[2], i, a, s, n.epsilon), b = (y) => {
            let g = re(t[0].dataType), _ = u === 1 ? "vec2f" : `mat${u}x2f`, w = (T) => {
    ...
    output[global_idx] = fma(input[global_idx], ${w(0)}, ${w(1)});
      ...
      var pc, mc, wa, $a = k(() => {
       ...
       Got scale size of ${c} and bias size of ${p}`);
          ...
          let m = J(l), h = ["type", "type"], b = [{ type: 12, data: d }, { type: 1, data: l }, { type: 12, data: Math.floor(l / m) }, { type: 1, data: t.epsilon }];
          s && h.push("type");
          let y = n > 1, g = n > 2, _ = (v) => {
    ...
    ${g ? "inv_std_output[global_idx] = inv_std_dev" : ""};
      ...
      var fc, va, xa = k(() => {
        ...
        fc = (e) => {
          ...
          fc(e.inputs);
          let t = Pe.calcShape(e.inputs[0].dims, e.inputs[1].dims, true);
          ...
          if (n < 8 && r < 8) e.compute(an(e.inputs, { activation: "" }, t));
            ...
            if (i !== 1 && o === 1 && s === 1) {
              ...
              e.compute(_t(l, { activation: "" }, t, d), { inputs: l });
            } else e.compute(_t(e.inputs, { activation: "" }, t));
          }
        };
      });
      var hc, gc, yc, Sa, Ta, Ia = k(() => {
        ...
        hc = (e, t) => {
          ...
          if (!x.areEqual(s.dims, [t.n, o, i])) throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");
          let u = e[2].dims;
          ...
          let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = J(t.k), f = J(l), m = J(s), h = a.concat([o, s]), b = o > 1 && s / m % 2 === 0 ? 2 : 1, y = x.size(h) / m / b, g = 64, _ = [], w = [u, o, i / p], v = x.convertShape(e[1].dims).slice();
          v.splice(-1, 1, l / f), _.push(...P(w)), _.push(...P(v)), _.push(...P(e[2].dims)), e.length === 4 && _.push(...P(x.convertShape(e[3].dims)));
          let $ = [u, o, s / m];
          _.push(...P($));
          let T = (I) => {
            let A = w.length, z = S("a", e[0].dataType, A, p), R = S("b", 12, v.length, f), D = S("scales", e[2].dataType, e[2].dims.length), U = [z, R, D], Q = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
            Q && U.push(Q);
            let O = $.length, M = C("output", e[0].dataType, O, m), V = re(e[0].dataType), W = (() => {
              switch (p) {
                case 1:
                  return `array<${V}, 8>`;
                case 2:
          ...
          `;
            ...
            b_quantized_values = ${W}(${Array.from({ length: 4 }, (E, N) => `${V}(b_value_lower[${N}]), ${V}(b_value_upper[${N}])`).join(", ")});
            b_dequantized_values = ${p === 1 ? `${W}(${Array.from({ length: 8 }, (E, N) => `(b_quantized_values[${N}] - ${Q ? `zero_point${q}` : "zero_point"}) * scale${q}`).join(", ")});` : `(b_quantized_values - ${W}(${Array(8).fill(`${Q ? `zero_point${q}` : "zero_point"}`).join(",")})) * scale${q};`};
        ...
        ${I.mainStart([g, 1, 1])}
          ...
          let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = J(t.k), f = J(l), m = a.concat([o, s]), h = 128, b = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, y = h / b, g = y * f * 8, _ = g / p, w = g / t.blockSize, v = x.size(m) / b, $ = [], T = [u, o, i / p], I = x.convertShape(e[1].dims).slice();
          I.splice(-1, 1, l / f), $.push(...P(T)), $.push(...P(I)), $.push(...P(e[2].dims)), e.length === 4 && $.push(...P(x.convertShape(e[3].dims)));
          let A = [u, o, s];
          $.push(...P(A));
          let z = (R) => {
            let D = T.length, U = S("a", e[0].dataType, D, p), Q = S("b", 12, I.length, f), O = S("scales", e[2].dataType, e[2].dims.length), M = [U, Q, O], V = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
            V && M.push(V);
            let W = A.length, H = C("output", e[0].dataType, W), X = re(e[0].dataType), oe = () => {
              switch (p) {
                case 1:
                  return `
        ...
        ${R.mainStart([y, b, 1])}
          ...
          return { name: "BlockwiseMatMulNBits32", shaderCache: { hint: `${t.blockSize};${p};${f};${y};${b}`, inputDependencies: Array(e.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: m, dataType: c }], dispatchGroup: { x: v }, programUniforms: $ }), getShaderSource: z };
        }, Sa = (e, t) => {
      ...
      var mn, Ea, ka, Pa, za, Ic, Cc, Ba, Da, Oa, Ma, Ua, Ra, Va, Na, La, Ga, Wa, Ha, qa = k(() => {
        "use strict";
        _e();
        L();
        F();
        ...
        mn = (e) => {
          ...
          l.push(...P(t.dims, i));
          let h = ["rank"];
          return { name: e, shaderCache: { hint: `${r.cacheKey};${p};${f};${m}`, inputDependencies: h }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(x.size(i) / 64) }, programUniforms: l }), getShaderSource: (b) => Pa(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m) };
        }, Oa = (e) => {
    ...
    `, a = "", u = S("x", t.dataType, t.dims.length), d = ["rank"], [l, c, p, f, m] = ka(i, o);
      ...
      var Ec, kc, Fa, Ka, ja = k(() => {
        ...
        Ec = (e, t) => {
          ...
          let n = x.normalizeAxis(t.axis, e[0].dims.length), r = e[0].dataType, o = r === 3, i = e[0].dims, s = e[1].dataType, a = x.size(i), u = r === 3 || r === 2, d = u ? [Math.ceil(x.size(e[0].dims) / 4)] : e[0].dims, l = e[1].dims, c = e.length > 2 ? e[2] : void 0, p = c ? u ? [Math.ceil(x.size(c.dims) / 4)] : c.dims : void 0, f = l.length === 0 || l.length === 1 && l[0] === 1, m = f === false && l.length === 1, h = J(a), b = f && (!u || h === 4), y = b ? h : 1, g = b && !u ? h : 1, _ = S("input", u ? 12 : r, d.length, g), w = S("scale", s, l.length), v = c ? S("zero_point", u ? 12 : r, p.length) : void 0, $ = C("output", s, i.length, y), T = [_, w];
          v && T.push(v);
          let I = [d, l];
          c && I.push(p);
          let A = [{ type: 12, data: a / y }, { type: 12, data: n }, { type: 12, data: t.blockSize }, ...P(...I, i)], z = (R) => {
            let D = [{ name: "output_size", type: "u32" }, { name: "axis", type: "u32" }, { name: "block_size", type: "u32" }];
            return `
      ...
      ${$.setByOffset("global_idx", `${$.type.value}(x_value - zero_point_value) * scale_value`)};
          ...
          return { name: "DequantizeLinear", shaderCache: { hint: t.cacheKey, inputDependencies: v ? ["rank", "rank", "rank"] : ["rank", "rank"] }, getShaderSource: z, getRunData: () => ({ outputs: [{ dims: i, dataType: s }], dispatchGroup: { x: Math.ceil(a / y / 64), y: 1, z: 1 }, programUniforms: A }) };
        }, Fa = (e, t) => {
          Ec(e.inputs, t), e.compute(kc(e.inputs, t));
        }, Ka = (e) => G({ axis: e.axis, blockSize: e.blockSize });
      });
      var Pc, zc, Za, Qa = k(() => {
        "use strict";
        _e();
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Bc(t.reduction, "output[data_offset + i]", "value", m.type.value)}
        ...
        }, Xa = (e) => G({ reduction: e.reduction }), Ya = (e, t) => {
          e.compute(Dc(e.inputs, t), { inputs: [e.inputs[1], e.inputs[2]], outputs: [] });
        };
      });
      var Oc, Mc, Uc, eu, Rc, Vc, Nc, Lc, Gc, Wc, Hc, qc, tu, Fc, Kc, jc, Zc, Qc, nu, ru, ou = k(() => {
        "use strict";
        L();
        F();
        ie();
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
          ...
          r.length === 0 && (d = s.map((g, _) => g === 0 ? 1 : u[_] / g), t.keepAspectRatioPolicy !== "stretch" && (u = Gc(s, d, t)));
          let l = C("output", e.dataType, u.length), c = S("input", e.dataType, s.length), p = x.size(u), f = s.length === u.length && s.every((g, _) => g === u[_]), m = t.coordinateTransformMode === "tf_crop_and_resize", h = t.extrapolationValue, b = c.type.value, y = (g) => `
      ${f ? "" : `
      ...
      ${(() => {
            switch (t.mode) {
              ...
              ${(() => {
                  if (s.length === 2 || s.length === 4) return `${Fc(c, l, s, m, h)}`;
                  if (s.length === 3 || s.length === 5) return `${jc(c, l, s, m, h)}`;
            ...
            `;
              case "cubic":
                return `
            ${(() => {
                  if (s.length === 2 || s.length === 4) return `${Kc(c, l, s, u, d, a, t.cubicCoeffA, m, t.extrapolationValue, t.excludeOutside)}`;
...
`}
          ...
          return G({ antialias: t, axes: n, coordinateTransformMode: r, cubicCoeffA: o, excludeOutside: i, extrapolationValue: s, keepAspectRatioPolicy: a, mode: u, nearestMode: d });
        };
      });
      var Xc, Yc, iu, su = k(() => {
        "use strict";
        ...
        Xc = (e) => {
          ...
          let o = t.simplified, i = e[0].dims, s = x.size(i), a = i, u = s, d = i.slice(-1)[0], l = r ? i.slice(0, -1).concat(1) : [], c = !o && e.length > 3, p = e.length > 4, f = r && n > 1, m = r && n > 2, h = n > 3, b = 64, y = J(d), g = [{ type: 12, data: u }, { type: 12, data: y }, { type: 12, data: d }, { type: 1, data: t.epsilon }], _ = (v) => {
            ...
            let I = re(e[0].dataType), A = re(1, y);
            return `
      ...
      ${v.mainStart([b, 1, 1])}
        ...
        for (var i: u32 = 0; i < stride; i++) {
          ...
          return n > 1 && w.push({ dims: l, dataType: 1 }), n > 2 && w.push({ dims: l, dataType: 1 }), n > 3 && w.push({ dims: i, dataType: e[0].dataType }), { name: "SkipLayerNormalization", shaderCache: { hint: `${y};${f};${m};${h}`, inputDependencies: e.map((v, $) => "type") }, getShaderSource: _, getRunData: () => ({ outputs: w, dispatchGroup: { x: Math.ceil(u / d) }, programUniforms: g }) };
        }, iu = (e, t) => {
          Xc(e.inputs);
          let r = [0];
      ...
      var Jc, fn, ep, au, tp, np, uu, du, lu = k(() => {
        ...
        Jc = (e, t) => {
          ...
          if (e.length > 1) {
            ...
            return o.length === 0 && (o = [...Array(e[0].dims.length).keys()]), G({ starts: n, ends: r, axes: o });
          } else return t;
        }, au = (e, t, n, r, o) => {
          let i = e;
      ...
      ${y.registerUniforms(m).declareVariables(p, c)}
        ...
        ${y.mainStart()}
          ...
          return G({ starts: t, ends: n, axes: r });
        };
      });
      var rp, op, cu, pu, mu = k(() => {
        ...
        rp = (e) => {
          ...
          p === 1 && (h = 256);
          let b = (T, I) => I === 4 ? `max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))` : I === 2 ? `max(${T}.x, ${T}.y)` : I === 3 ? `max(max(${T}.x, ${T}.y), ${T}.z)` : T, y = S("x", u.dataType, u.dims, f), g = C("result", u.dataType, u.dims, f), _ = y.type.value, w = re(u.dataType) === "f32" ? `var threadMax = ${_}(-3.4028234663852886e+38f);` : `var threadMax = ${_}(-65504.0h);`, v = (T) => `
      ...
      var up, dp, yu, bu = k(() => {
        ...
        ${d}
          ...
          if (i) {
            let d = Pe.calcShape(Pe.calcShape(t, n, false), r, false);
      ...
      var _u, wu = k(() => {
        ...
        rn();
        bu();
        _u = /* @__PURE__ */ new Map([["Abs", [si]], ["Acos", [ai]], ["Acosh", [ui]], ["Add", [qi]], ["ArgMax", [Jo, jn]], ["ArgMin", [Yo, jn]], ["Asin", [di]], ["Asinh", [li]], ["Atan", [ci]], ["Atanh", [pi]], ["Attention", [ti]], ["AveragePool", [Ma, Oa]], ["BatchNormalization", [ni]], ["BiasAdd", [oi]], ["BiasSplitGelu", [Wi]], ["Cast", [fi, mi]], ["Ceil", [gi]], ["Clip", [hi]], ["Concat", [ns, rs]], ["Conv", [rr, nr]], ["ConvTranspose", [Is, Ss]], ["Cos", [yi]], ["Cosh", [bi]], ["CumSum", [As, Es]], ["DepthToSpace", [Ps, zs]], ["DequantizeLinear", [Fa, Ka]], ["Div", [Fi]], ["Einsum", [Ms, Us]], ["Elu", [_i, yt]], ["Equal", [Ki]], ["Erf", [wi]], ["Exp", [$i]], ["Expand", [Ns]], ["FastGelu", [Gs]], ["Floor", [vi]], ["FusedConv", [rr, nr]], ["Gather", [qs, Hs]], ["GatherElements", [ea, Js]], ["GatherBlockQuantized", [Qs, Xs]], ["GatherND", [Ks, js]], ["Gelu", [xi]], ["Gemm", [ra, na]], ["GlobalAveragePool", [Va, Ra]], ["GlobalMaxPool", [Ha, Wa]], ["Greater", [Xi]], ["GreaterOrEqual", [Ji]], ["GridSample", [ia, sa]], ["GroupQueryAttention", [ha]], ["HardSigmoid", [Pi, ki]], ["InstanceNormalization", [ba]], ["LayerNormalization", [wa]], ["LeakyRelu", [Si, yt]], ["Less", [Yi]], ["LessOrEqual", [es]], ["Log", [Ni]], ["MatMul", [va]], ["MatMulNBits", [Sa, Ta]], ["MaxPool", [La, Ga]], ["Mul", [ji]], ["MultiHeadAttention", [la, da]], ["Neg", [Ii]], ["Not", [Ti]], ["Pad", [Ca]], ["Pow", [Zi]], ["QuickGelu", [Li, yt]], ["Range", [Za]], ["Reciprocal", [Ci]], ["ReduceMin", [Fo]], ["ReduceMean", [Lo]], ["ReduceMax", [qo]], ["ReduceSum", [jo]], ["ReduceProd", [Ko]], ["ReduceL1", [Go]], ["ReduceL2", [Wo]], ["ReduceLogSum", [Qo]], ["ReduceLogSumExp", [Ho]], ["ReduceSumSquare", [Zo]], ["Relu", [Ai]], ["Resize", [nu, ru]], ["RotaryEmbedding", [ma]], ["ScatterND", [Ya, Xa]], ["Sigmoid", [Ei]], ["Sin", [zi]], ["Sinh", [Bi]], ["Slice", [uu, du]], ["SkipLayerNormalization", [iu]], ["Split", [ca, pa]], ["Sqrt", [Di]], ["Softmax", [cu, pu]], ["Sub", [Qi]], ["Tan", [Oi]], ["Tanh", [Ui]], ["ThresholdedRelu", [Vi, yt]], ["Tile", [hu]], ["Transpose", [Ao, Eo]], ["Where", [yu]]]);
      });
      var hn, $u = k(() => {
        "use strict";
        _e();
...
${a}`, d = r.createShaderModule({ code: u, label: t.name });
            ...
            return he(t.name), { programInfo: t, computePipeline: l, uniformVariablesInfo: s.variablesInfo };
          }
        ...
        lp = (e, t) => {
          ...
          flush() {
            ...
            this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), t = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(t, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, t, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && t.mapAsync(GPUMapMode.READ).then(() => {
              ...
              for (let o = 0; o < n.length / 2; o++) {
                ...
                if (!Number.isSafeInteger(h) || !Number.isSafeInteger(b)) throw new RangeError("incorrect timestamp range");
                if (this.env.webgpu.profiling?.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: c.map((y) => ({ dims: y.dims, dataType: Ee(y.dataType) })), outputsMetadata: p.map((y) => ({ dims: y.dims, dataType: Ee(y.dataType) })), kernelId: s, kernelType: u, kernelName: d, programName: l, startTime: h, endTime: b });
                else {
                  let y = "";
                  c.forEach((_, w) => {
                    y += `input[${w}]: [${_.dims}] | ${Ee(_.dataType)}, `;
                  });
                  let g = "";
                  p.forEach((_, w) => {
                    g += `output[${w}]: [${_.dims}] | ${Ee(_.dataType)}, `;
                  }), console.log(`[profiling] kernel "${s}|${u}|${d}|${l}" ${y}${g}start time: ${h} ns, execution time: ${b - h} ns`);
                }
                pt("GPU", `${l}::${f}::${m}`);
              }
          ...
          run(t, n, r, o, i, s) {
            ...
            for (let _ = 0; _ < u.length; ++_) {
              if (!Number.isInteger(c[_]) || c[_] < -3 || c[_] >= s) throw new Error(`Invalid output index: ${c[_]}`);
              if (c[_] === -3) continue;
              let w = c[_] === -1, v = c[_] === -2, $ = w || v ? i(u[_].dataType, u[_].dims) : o(c[_], u[_].dataType, u[_].dims);
            ...
            if (a.length !== n.length || f.length !== p.length) {
              if (f.length === 0) return he(t.name), p;
            ...
            if (l) {
              ...
              l.forEach((I) => {
                ...
                let z = I.type === 10 ? 2 : 4, R, D;
                I.type === 10 ? (D = A.length > 4 ? 16 : A.length > 2 ? 8 : A.length * z, R = A.length > 4 ? 16 : z * A.length) : (D = A.length <= 2 ? A.length * z : 16, R = 16), _ = Math.ceil(_ / D) * D, w.push(_);
                let U = I.type === 10 ? 8 : 4;
                _ += A.length > 4 ? Math.ceil(A.length / U) * R : A.length * z;
              });
              let v = 16;
              _ = Math.ceil(_ / v) * v;
              let $ = new ArrayBuffer(_);
              l.forEach((I, A) => {
                let z = w[A], R = typeof I.data == "number" ? [I.data] : I.data;
                if (I.type === 6) new Int32Array($, z, R.length).set(R);
                else if (I.type === 12) new Uint32Array($, z, R.length).set(R);
                else if (I.type === 10) new Uint16Array($, z, R.length).set(R);
                else if (I.type === 1) new Float32Array($, z, R.length).set(R);
                else throw new Error(`Unsupported uniform type: ${Ee(I.type)}`);
              });
              let T = this.gpuDataManager.create(_, GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM);
              this.device.queue.writeBuffer(T.buffer, 0, $, 0, _), this.gpuDataManager.release(T.id), m = { offset: 0, size: _, buffer: T.buffer };
            }
            let h = this.programManager.normalizeDispatchGroupSize(d), b = h[1] === 1 && h[2] === 1, y = cp(t, n, b), g = this.programManager.getArtifact(y);
            if (g || (g = this.programManager.build(t, h), this.programManager.setArtifact(y, g), Z("info", () => `[artifact] key: ${y}, programName: ${t.name}`)), l && g.uniformVariablesInfo) {
              ...
              for (let _ = 0; _ < l.length; _++) {
                let w = l[_], v = w.type, $ = typeof w.data == "number" ? 1 : w.data.length, [T, I] = g.uniformVariablesInfo[_];
                if (v !== T || $ !== I) throw new Error(`Uniform variable ${_} mismatch: expect type ${T} with size ${I}, got type ${v} with size ${$} in program "${g.programInfo.name}".`);
              }
            }
            ...
            return this.programManager.run(g, a, f, h, m), he(t.name), p;
          }
          upload(t, n) {
      ...
      var $t, mr, pp, Tu = k(() => {
        ...
        $t = class e {
          ...
          compute(t, n) {
            let r = n?.inputs?.map((a) => typeof a == "number" ? this.inputs[a] : a) ?? this.inputs, o = n?.outputs ?? [], i = (a, u, d) => new $t(this.module, u, this.output(a, d), d), s = (a, u) => {
              let d = qe(a, u);
              if (!d) throw new Error(`Unsupported data type: ${a}`);
              let l = d > 0 ? this.backend.gpuDataManager.create(d).id : 0;
              return new $t(this.module, a, l, u);
            };
          ...
          if (e === "webgpu") {
            let i = (xu(), lt(vu)).WebGpuBackend, s = new i();
      ...
      var mp, kt, Pt, tt, fp, Iu, mt, zt, Bt, Cu, Dt, Ot, Mt, En = k(() => {
        "use strict";
        _e();
        io();
        ao();
        ...
        mp = (e, t) => {
          ...
          mp(e.wasm.numThreads, ht(e.logLevel));
        }, Pt = async (e, t) => {
          ne().asyncInit?.();
          ...
          let n, r, o = ne();
          Array.isArray(e) ? [n, r] = e : e.buffer === o.HEAPU8.buffer ? [n, r] = [e.byteOffset, e.byteLength] : [n, r] = mt(e);
          ...
          try {
            if ([s, u] = await so(t), t?.externalData && o.mountExternalData) {
              ...
              for (let v of t.externalData) {
                ...
                w.push(gt(typeof v == "string" ? v : v.data).then((T) => {
            ...
            for (let w of t?.executionProviders ?? []) if ((typeof w == "string" ? w : w.name) === "webnn") {
              if (o.shouldTransferToMLTensor = false, typeof w != "string") {
                let $ = w, T = $?.context, I = $?.gpuDevice, A = $?.deviceType, z = $?.powerPreference;
                T ? o.currentContext = T : I ? o.currentContext = await o.webnnCreateMLContext(I) : o.currentContext = await o.webnnCreateMLContext({ deviceType: A, powerPreference: z });
            ...
            let [c, p] = fp(i), f = !!t?.enableGraphCapture, m = [], h = [], b = [], y = [], g = [];
            for (let w = 0; w < c; w++) {
              let [v, $, T] = Iu(i, w);
              v === 0 && Y("Can't get an input name."), d.push(v);
              let I = o.UTF8ToString(v);
              m.push(I), b.push($ === 0 ? { name: I, isTensor: false } : { name: I, isTensor: true, type: Ee($), shape: T });
            }
            for (let w = 0; w < p; w++) {
              let [v, $, T] = Iu(i, w + c);
              v === 0 && Y("Can't get an output name."), l.push(v);
              let I = o.UTF8ToString(v);
              h.push(I), y.push($ === 0 ? { name: I, isTensor: false } : { name: I, isTensor: true, type: Ee($), shape: T });
              {
                if (f && t?.preferredOutputLocation === void 0) {
                  g.push("gpu-buffer");
                  continue;
                }
                let A = typeof t?.preferredOutputLocation == "string" ? t.preferredOutputLocation : t?.preferredOutputLocation?.[I] ?? "cpu", z = o.webnnIsGraphOutput;
                if (A === "cpu" && z && z(i, I)) {
                ...
                if (f && A !== "gpu-buffer") throw new Error(`Not supported preferred output location: ${A}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);
                g.push(A);
              }
            }
            let _ = null;
            return g.some((w) => w === "gpu-buffer" || w === "ml-tensor" || w === "ml-tensor-cpu-output") && (a = o._OrtCreateBinding(i), a === 0 && Y("Can't create IO binding."), _ = { handle: a, outputPreferredLocations: g, outputPreferredLocationsEncoded: g.map((w) => w === "ml-tensor-cpu-output" ? "ml-tensor" : w).map((w) => Bn(w)) }), tt.set(i, [i, d, l, _, f, false]), [i, m, h, b, y];
          } catch (c) {
          ...
          if (c === "gpu-buffer") {
            ...
            if (Array.isArray(y)) {
              ...
              for (let g = 0; g < y.length; g++) {
                ...
                a.setValue(f + g * u, $e(y[g], n), "*");
              }
            } else {
              let g = a.webnnIsGraphInput, _ = a.webnnIsGraphOutput;
              if (d !== "string" && g && _) {
          ...
          let h = a.stackSave(), b = a.stackAlloc(4 * l.length);
          try {
            l.forEach((g, _) => a.setValue(b + _ * u, g, u === 4 ? "i32" : "i64"));
            let y = a._OrtCreateTensor(He(d), f, m, b, l.length, Bn(p));
            y === 0 && Y(`Can't create tensor for input/output. session=${r}, index=${i}.`), t.push(y);
          } finally {
            a.stackRestore(h);
          }
        }, Dt = async (e, t, n, r, o, i) => {
          let s = ne(), a = s.PTR_SIZE, u = tt.get(e);
          if (!u) throw new Error(`cannot run inference. invalid session id: ${e}`);
          let d = u[0], l = u[1], c = u[2], p = u[3], f = u[4], m = u[5], h = t.length, b = r.length, y = 0, g = [], _ = [], w = [], v = [], $ = [], T = s.stackSave(), I = s.stackAlloc(h * a), A = s.stackAlloc(h * a), z = s.stackAlloc(b * a), R = s.stackAlloc(b * a);
          try {
            [y, g] = oo(i), Ue("wasm prepareInputOutputTensor");
            for (let O = 0; O < h; O++) await Cu(n[O], _, v, e, l[t[O]], t[O], f);
            for (let O = 0; O < b; O++) await Cu(o[O], w, v, e, c[r[O]], h + r[O], f);
            Re("wasm prepareInputOutputTensor");
            for (let O = 0; O < h; O++) s.setValue(I + O * a, _[O], "*"), s.setValue(A + O * a, l[t[O]], "*");
            for (let O = 0; O < b; O++) s.setValue(z + O * a, w[O], "*"), s.setValue(R + O * a, c[r[O]], "*");
            if (p && !m) {
              let { handle: O, outputPreferredLocations: M, outputPreferredLocationsEncoded: V } = p;
              if (l.length !== h) throw new Error(`input count from feeds (${h}) is expected to be always equal to model's input count (${l.length}).`);
              Ue("wasm bindInputsOutputs");
              for (let W = 0; W < h; W++) {
                let H = t[W];
                await s._OrtBindInput(O, l[H], _[W]) !== 0 && Y(`Can't bind input[${W}] for session=${e}.`);
              }
              for (let W = 0; W < b; W++) {
                let H = r[W];
                o[W]?.[3] ? ($.push(w[W]), s._OrtBindOutput(O, c[H], w[W], 0) !== 0 && Y(`Can't bind pre-allocated output[${W}] for session=${e}.`)) : s._OrtBindOutput(O, c[H], 0, V[H]) !== 0 && Y(`Can't bind output[${W}] to ${M[W]} for session=${e}.`);
              }
              Re("wasm bindInputsOutputs"), tt.set(e, [d, l, c, p, f, true]);
            }
            s.jsepOnRunStart?.(d), s.webnnOnRunStart?.(d);
            let D;
            p ? D = await s._OrtRunWithBinding(d, p.handle, b, z, y) : D = await s._OrtRun(d, A, I, h, R, b, z, y), D !== 0 && Y("failed to call OrtRun().");
            let U = [], Q = [];
            Ue("wasm ProcessOutputTensor");
            for (let O = 0; O < b; O++) {
              let M = Number(s.getValue(z + O * a, "*"));
              if (M === w[O] || $.includes(w[O])) {
                U.push(o[O]), M !== w[O] && s._OrtReleaseTensor(M) !== 0 && Y("Can't release tensor.");
                continue;
              }
              let V = s.stackSave(), W = s.stackAlloc(4 * a), H = false, X, oe = 0;
              try {
                s._OrtGetTensorData(M, W, W + a, W + 2 * a, W + 3 * a) !== 0 && Y(`Can't access output tensor data on index ${O}.`);
                let q = a === 4 ? "i32" : "i64", E = Number(s.getValue(W, q));
                oe = s.getValue(W + a, "*");
                let N = s.getValue(W + a * 2, "*"), se = Number(s.getValue(W + a * 3, q)), ve = [];
                for (let me = 0; me < se; me++) ve.push(Number(s.getValue(N + me * a, q)));
                s._OrtFree(N) !== 0 && Y("Can't free memory for tensor dims.");
                let ge = ve.reduce((me, ae) => me * ae, 1);
                X = Ee(E);
                let je = p?.outputPreferredLocations[r[O]];
                if (X === "string") {
                  if (je === "gpu-buffer" || je === "ml-tensor") throw new Error("String tensor is not supported on GPU.");
                  let me = [];
                  for (let ae = 0; ae < ge; ae++) {
                    let Le = s.getValue(oe + ae * a, "*"), xt = s.getValue(oe + (ae + 1) * a, "*"), yr = ae === ge - 1 ? void 0 : xt - Le;
                    me.push(s.UTF8ToString(Le, yr));
                  }
                  U.push([X, ve, me, "cpu"]);
                } else if (je === "gpu-buffer" && ge > 0) {
                  let me = s.jsepGetBuffer;
                  if (!me) throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');
                  let ae = me(oe), Le = qe(E, ge);
                  if (Le === void 0 || !Lt(X)) throw new Error(`Unsupported data type: ${X}`);
                  H = true, U.push([X, ve, { gpuBuffer: ae, download: s.jsepCreateDownloader(ae, Le, X), dispose: () => {
                    s._OrtReleaseTensor(M) !== 0 && Y("Can't release tensor.");
                  } }, "gpu-buffer"]);
                } else if (je === "ml-tensor" && ge > 0) {
                  let me = s.webnnEnsureTensor, ae = s.webnnIsGraphInputOutputTypeSupported;
                  if (!me || !ae) throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');
                  if (qe(E, ge) === void 0 || !Gt(X)) throw new Error(`Unsupported data type: ${X}`);
                  if (!ae(e, X, false)) throw new Error(`preferredLocation "ml-tensor" for ${X} output is not supported by current WebNN Context.`);
                  let xt = await me(e, oe, E, ve, false);
                  H = true, U.push([X, ve, { mlTensor: xt, download: s.webnnCreateMLTensorDownloader(oe, X), dispose: () => {
                    s.webnnReleaseTensorId(oe), s._OrtReleaseTensor(M);
                  } }, "ml-tensor"]);
                } else if (je === "ml-tensor-cpu-output" && ge > 0) {
                  let me = s.webnnCreateMLTensorDownloader(oe, X)(), ae = U.length;
                  H = true, Q.push((async () => {
                    let Le = [ae, await me];
                    return s.webnnReleaseTensorId(oe), s._OrtReleaseTensor(M), Le;
                  })()), U.push([X, ve, [], "cpu"]);
                } else {
                  let me = ot(X), ae = new me(ge);
                  new Uint8Array(ae.buffer, ae.byteOffset, ae.byteLength).set(s.HEAPU8.subarray(oe, oe + ae.byteLength)), U.push([X, ve, ae, "cpu"]);
                }
              } finally {
                s.stackRestore(V), X === "string" && oe && s._free(oe), H || s._OrtReleaseTensor(M);
              }
            }
            p && !f && (s._OrtClearBoundOutputs(p.handle) !== 0 && Y("Can't clear bound outputs."), tt.set(e, [d, l, c, p, f, false]));
            for (let [O, M] of await Promise.all(Q)) U[O][2] = M;
            return Re("wasm ProcessOutputTensor"), U;
          } finally {
            s.webnnOnRunEnd?.(d), s.stackRestore(T), _.forEach((D) => s._OrtReleaseTensor(D)), w.forEach((D) => s._OrtReleaseTensor(D)), v.forEach((D) => s._free(D)), y !== 0 && s._OrtReleaseRunOptions(y), g.forEach((D) => s._free(D));
          }
        }, Ot = (e) => {
          let t = ne(), n = tt.get(e);
      ...
      var nt, Se, vt, yn, bn, gn, fr, hr, ut, dt, gp, Au, Eu, ku, Pu, zu, Bu, Du, gr = k(() => {
        "use strict";
        _e();
        En();
        We();
        At();
        nt = () => !!te.wasm.proxy && typeof document < "u", vt = false, yn = false, bn = false, hr = /* @__PURE__ */ new Map(), ut = (e, t) => {
          let n = hr.get(e);
          n ? n.push(t) : hr.set(e, [t]);
        }, dt = () => {
          if (vt || !yn || bn || !Se) throw new Error("worker not ready");
        }, gp = (e) => {
          switch (e.data.type) {
            case "init-wasm":
              vt = false, e.data.err ? (bn = true, fr[1](e.data.err)) : (yn = true, fr[0]()), gn && (URL.revokeObjectURL(gn), gn = void 0);
              break;
            case "init-ep":
            case "copy-from":
            case "create":
          ...
          if (!yn) {
            if (vt) throw new Error("multiple calls to 'initWasm()' detected.");
            if (bn) throw new Error("previous call to 'initWasm()' failed.");
            if (vt = true, nt()) return new Promise((e, t) => {
            ...
            try {
              await Et(te.wasm), await kt(te), yn = true;
            } catch (e) {
              throw bn = true, e;
            } finally {
              vt = false;
          ...
          if (nt()) {
            ...
            return dt(), new Promise((s, a) => {
              ...
              Se.postMessage(d, Mt(u));
            });
          } else return Dt(e, t, n, r, o, i);
        }, Du = async (e) => {
          if (nt()) return dt(), new Promise((t, n) => {
      ...
      var Ou, yp, _n, Mu = k(() => {
        ...
        Ou = (e, t) => {
          ...
          switch (e[3]) {
            ...
            case "ml-tensor": {
              let t = e[0];
              if (!Gt(t)) throw new Error(`not supported data type: ${t} for deserializing MLTensor tensor`);
          ...
          async fetchModelAndCopyToWasmMemory(t) {
            return ku(await gt(t));
          }
          async loadModel(t, n) {
            ye();
            let r;
            typeof t == "string" ? r = await this.fetchModelAndCopyToWasmMemory(t) : r = t, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await Pu(r, n), he();
          }
          async dispose() {
          ...
          async run(t, n, r) {
            ...
            for (let p = 0; p < l.length; p++) c[this.outputNames[a[p]]] = s[p] ?? yp(l[p]);
            return he(), c;
          }
          startProfiling() {
          }
      ...
      var Uu, wn, bp, Vu = k(() => {
        ...
        Uu = () => {
          ...
          let e = te.wasm.simd;
          if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), te.wasm.simd = false), typeof te.wasm.proxy != "boolean" && (te.wasm.proxy = false), typeof te.wasm.trace != "boolean" && (te.wasm.trace = false), typeof te.wasm.numThreads != "number" || !Number.isInteger(te.wasm.numThreads) || te.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) te.wasm.numThreads = 1;
          else {
      ...
      var wp = {};
      rt(wp, { InferenceSession: () => Lr, TRACE: () => pt, TRACE_EVENT_BEGIN: () => Ue, TRACE_EVENT_END: () => Re, TRACE_FUNC_BEGIN: () => ye, TRACE_FUNC_END: () => he, Tensor: () => xe, default: () => _p, env: () => te, registerBackend: () => Ge });
      _e();
      _e();
      _e();
      var Kr = "1.24.3";
...
var require_common = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/models/common.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});
...
var require_legacy = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/models/legacy.js"(exports) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_v5 = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/models/v5.js"(exports) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_models = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/models/index.js"(exports) {
    "use strict";
...
var require_resampler = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/resampler.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_non_real_time_vad = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/non-real-time-vad.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
var require_utils = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_ort_wasm_min = __commonJS({
  "node_modules/onnxruntime-web/dist/ort.wasm.min.js"(exports, module) {
    "use strict";
    var ort = (() => {
      ...
      var Ye = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof __require < "u" ? __require : t)[n] }) : e)(function(e) {
        if (typeof __require < "u") return __require.apply(this, arguments);
        throw Error('Dynamic require of "' + e + '" is not supported');
      });
      ...
      var Ee = (e, t) => {
        ...
        if (t && typeof t == "object" || typeof t == "function") for (let r of Ln(t)) !Pn.call(e, r) && r !== n && Je(e, r, { get: () => t[r], enumerable: !(o = Bn(t, r)) || o.enumerable });
        return e;
      };
      var qe = (e) => Dn(Je({}, "__esModule", { value: true }), e);
      var Se, K, se, _n, bt, Ze = E(() => {
        "use strict";
        Se = /* @__PURE__ */ new Map(), K = [], se = (e, t, n) => {
          if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
            let o = Se.get(e);
            ...
            if (n >= 0) {
              let r = K.indexOf(e);
              r !== -1 && K.splice(r, 1);
              for (let i = 0; i < K.length; i++) if (Se.get(K[i]).priority <= n) {
                K.splice(i, 0, e);
                return;
              }
              K.push(e);
      ...
      var St, D, Xe = E(() => {
        "use strict";
        Et();
        St = "warning", D = { wasm: {}, webgl: {}, webgpu: {}, versions: { common: gt }, set logLevel(e) {
          if (e !== void 0) {
            if (typeof e != "string" || ["verbose", "info", "warning", "error", "fatal"].indexOf(e) === -1) throw new Error(`Unsupported logging level: ${e}`);
            St = e;
          }
      ...
      var It, At, Ot = E(() => {
        ...
        It = (e, t) => {
          ...
          if (o != null) {
            ...
            for (let y = 0; y < i; y++) for (let O = 0; O < r; O++) {
          ...
          if (n != null) {
            ...
            for (let T = 0; T < i * r; p += d, h += d, y += d, O += d, T++) o.data[p] = (e.data[m++] - l[0]) * f[0], o.data[h] = (e.data[w++] - l[1]) * f[1], o.data[y] = (e.data[B++] - l[2]) * f[2], o.data[O] = g === -1 ? 255 : (e.data[g++] - l[3]) * f[3];
          } else throw new Error("Can not access image data");
          return o;
        };
      });
      var Ke, Bt, Lt, Pt, Dt, _t, Ut = E(() => {
        "use strict";
        Te();
        Ke = (e, t) => {
          if (e === void 0) throw new Error("Image buffer must be defined");
          ...
          let a = t.format !== void 0 ? t.format : "RGBA", u = t.tensorFormat !== void 0 && t.tensorFormat !== void 0 ? t.tensorFormat : "RGB", f = n * o, l = u === "RGBA" ? new Float32Array(f * 4) : new Float32Array(f * 3), c = 4, d = 0, p = 1, h = 2, y = 3, O = 0, m = f, w = f * 2, B = -1;
          a === "RGB" && (c = 3, d = 0, p = 1, h = 2, y = -1), u === "RGBA" ? B = f * 3 : u === "RBG" ? (O = 0, w = f, m = f * 2) : u === "BGR" && (w = 0, m = f, O = f * 2);
          for (let T = 0; T < f; T++, d += c, h += c, p += c, y += c) l[O++] = (e[d] + s[0]) / i[0], l[m++] = (e[p] + s[1]) / i[1], l[w++] = (e[h] + s[2]) / i[2], B !== -1 && y !== -1 && (l[B++] = (e[y] + s[3]) / i[3]);
      ...
      var Q, pe, xt, vt, Ct = E(() => {
        ...
        Q = /* @__PURE__ */ new Map([["float32", Float32Array], ["uint8", Uint8Array], ["int8", Int8Array], ["uint16", Uint16Array], ["int16", Int16Array], ["int32", Int32Array], ["bool", Uint8Array], ["float64", Float64Array], ["uint32", Uint32Array], ["int4", Uint8Array], ["uint4", Uint8Array]]), pe = /* @__PURE__ */ new Map([[Float32Array, "float32"], [Uint8Array, "uint8"], [Int8Array, "int8"], [Uint16Array, "uint16"], [Int16Array, "int16"], [Int32Array, "int32"], [Float64Array, "float64"], [Uint32Array, "uint32"]]), xt = false, vt = () => {
          if (!xt) {
            ...
            e && (Q.set("int64", BigInt64Array), pe.set(BigInt64Array, "int64")), t && (Q.set("uint64", BigUint64Array), pe.set(BigUint64Array, "uint64")), o ? (Q.set("float16", n), pe.set(n, "float16")) : Q.set("float16", Uint16Array);
          }
        };
      });
      var Mt, Rt, Ft = E(() => {
      ...
      var et, Nt, J, Y, q, Z, tt = E(() => {
        ...
        et = (e, t) => {
          ...
          (typeof D.trace > "u" ? !D.wasm.trace : !D.trace) || Nt("BEGIN", e);
        }, Y = (e) => {
          (typeof D.trace > "u" ? !D.wasm.trace : !D.trace) || Nt("END", e);
        }, q = (e) => {
      ...
      var Ie, kt = E(() => {
        ...
        Ie = class e {
          ...
          async run(t, n, o) {
            ...
            return Z("InferenceSession.run"), Y(), u;
          }
          async release() {
            return this.handler.dispose();
          }
          static async create(t, n, o, r) {
            J(), q("InferenceSession.create");
            let i, s = {};
            if (typeof t == "string") {
              if (i = t, typeof n == "object" && n !== null) s = n;
              else if (typeof n < "u") throw new TypeError("'options' must be an object.");
            ...
            return Z("InferenceSession.create"), Y(), new e(f);
          }
          startProfiling() {
            this.handler.startProfiling();
          }
      ...
      var nt = {};
      Ee(nt, { InferenceSession: () => Wt, TRACE: () => et, TRACE_EVENT_BEGIN: () => q, TRACE_EVENT_END: () => Z, TRACE_FUNC_BEGIN: () => J, TRACE_FUNC_END: () => Y, Tensor: () => k, env: () => A, registerBackend: () => se });
      var X = E(() => {
        "use strict";
        yt();
        Tt();
      ...
      var Jt, Yt, Un, Zt = E(() => {
        ...
        ee();
        Oe();
        Jt = "ort-wasm-proxy-worker", Yt = globalThis.self?.name === Jt;
        Yt && (self.onmessage = (e) => {
          let { type: t, in: n } = e.data;
          try {
            switch (t) {
        ...
        Un = Yt ? null : (e) => new Worker(e ?? R, { type: "classic", name: Jt });
      });
      var xn, vn, R, Ce, ot, Cn, Mn, Qt, Rn, Xt, en, Kt, tn, Oe = E(() => {
        "use strict";
        Ae();
        xn = typeof location > "u" ? void 0 : location.origin, vn = () => {
          ...
          /*@vite-ignore*/
          e
        )).default, Xt = (Zt(), qe(qt)).default, en = async () => {
      ...
      var st, it, Me, nn, Fn, Nn, kn, Be, I, ee = E(() => {
        "use strict";
        Oe();
        it = false, Me = false, nn = false, Fn = () => {
          if (typeof SharedArrayBuffer > "u") return false;
          try {
            return typeof MessageChannel < "u" && new MessageChannel().port1.postMessage(new SharedArrayBuffer(1)), WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 4, 1, 3, 1, 1, 10, 11, 1, 9, 0, 65, 0, 254, 16, 2, 0, 26, 11]));
          } catch {
          ...
          if (t > 0 && h.push(new Promise((y) => {
            ...
            d(m).then((w) => {
              Me = false, it = true, st = w, y(), c && URL.revokeObjectURL(c);
            }, (w) => {
              Me = false, nn = true, O(w);
            });
      ...
      var rn, on = E(() => {
        ...
        rn = (e) => {
          ...
          try {
            ...
            let i = 0;
            return e?.tag !== void 0 && (i = F(e.tag, o)), n = t._OrtCreateRunOptions(r.logSeverityLevel, r.logVerbosityLevel, !!r.terminate, i), n === 0 && S("Can't create run options."), e?.extra !== void 0 && we(e.extra, "", /* @__PURE__ */ new WeakSet(), (s, a) => {
              let u = F(s, o), f = F(a, o);
      ...
      var Wn, Gn, $n, Fe, zn, sn, an = E(() => {
        ...
        Wn = (e) => {
            ...
            switch (i) {
              ...
              case "webgpu":
                if (i = "JS", typeof r != "string") {
                  ...
                  if (c?.preferredLayout) {
                    if (c.preferredLayout !== "NCHW" && c.preferredLayout !== "NHWC") throw new Error(`preferredLayout must be either 'NCHW' or 'NHWC': ${c.preferredLayout}`);
                    Fe(e, "preferredLayout", c.preferredLayout, n);
                  }
                }
                break;
              case "wasm":
          ...
          try {
            ...
            return r.extra !== void 0 && we(r.extra, "", /* @__PURE__ */ new WeakSet(), (c, d) => {
              Fe(n, c, d, o);
            }), [n, o];
          } catch (i) {
      ...
      var ie, Ne, ae, un, fn, ke, We, cn, at = E(() => {
        "use strict";
        ie = (e) => {
          switch (e) {
            case "int8":
      ...
      var he, ut = E(() => {
        ...
        he = async (e) => {
          if (typeof e == "string") if (false) try {
            let { readFile: t } = Ye("node:fs/promises");
            return new Uint8Array(await t(e));
          } catch (t) {
            if (t.code === "ERR_FS_FILE_TOO_LARGE") {
              let { createReadStream: n } = Ye("node:fs"), o = n(e), r = [];
      ...
      var Hn, Le, Pe, ue, jn, dn, me, De, _e, ln, Ue, xe, ve, rt = E(() => {
        "use strict";
        X();
        on();
        an();
        ...
        Hn = (e, t) => {
          ...
          let n, o, r = I();
          Array.isArray(e) ? [n, o] = e : e.buffer === r.HEAPU8.buffer ? [n, o] = [e.byteOffset, e.byteLength] : [n, o] = me(e);
          ...
          try {
            if ([s, u] = await sn(t), t?.externalData && r.mountExternalData) {
              ...
              for (let T of t.externalData) {
                ...
                g.push(he(typeof T == "string" ? T : T.data).then((M) => {
            ...
            return ue.set(i, [i, f, l, null, p, false]), [i, h, y, O, m];
          } catch (c) {
          ...
          try {
            ...
            let m = a._OrtCreateTensor(ie(f), p, h, O, l.length, cn(d));
          ...
          if (!u) throw new Error(`cannot run inference. invalid session id: ${e}`);
          let f = u[0], l = u[1], c = u[2], d = u[3], p = u[4], h = u[5], y = t.length, O = o.length, m = 0, w = [], B = [], g = [], T = [], U = [], M = s.stackSave(), v = s.stackAlloc(y * a), de = s.stackAlloc(y * a), re = s.stackAlloc(O * a), lt = s.stackAlloc(O * a);
          try {
            [m, w] = rn(i), q("wasm prepareInputOutputTensor");
            for (let b = 0; b < y; b++) await ln(n[b], B, T, e, l[t[b]], t[b], p);
            for (let b = 0; b < O; b++) await ln(r[b], g, T, e, c[o[b]], y + o[b], p);
            Z("wasm prepareInputOutputTensor");
            for (let b = 0; b < y; b++) s.setValue(v + b * a, B[b], "*"), s.setValue(de + b * a, l[t[b]], "*");
            for (let b = 0; b < O; b++) s.setValue(re + b * a, g[b], "*"), s.setValue(lt + b * a, c[o[b]], "*");
            s.jsepOnRunStart?.(f), s.webnnOnRunStart?.(f);
            let N;
            N = await s._OrtRun(f, de, v, y, lt, O, re, m), N !== 0 && S("failed to call OrtRun().");
            let z = [], pt = [];
            q("wasm ProcessOutputTensor");
            for (let b = 0; b < O; b++) {
              ...
              try {
                ...
                let Ve = a === 4 ? "i32" : "i64", ye = Number(s.getValue($, Ve));
                C = s.getValue($ + a, "*");
                let wt = s.getValue($ + a * 2, "*"), On = Number(s.getValue($ + a * 3, Ve)), H = [];
                for (let _ = 0; _ < On; _++) H.push(Number(s.getValue(wt + _ * a, Ve)));
                s._OrtFree(wt) !== 0 && S("Can't free memory for tensor dims.");
                let j = H.reduce((_, L) => _ * L, 1);
                P = Ne(ye);
                ...
                if (P === "string") {
                  ...
                  let _ = [];
                  for (let L = 0; L < j; L++) {
                    let V = s.getValue(C + L * a, "*"), ge = s.getValue(C + (L + 1) * a, "*"), ht = L === j - 1 ? void 0 : ge - V;
                    _.push(s.UTF8ToString(V, ht));
                  }
                  z.push([P, H, _, "cpu"]);
                } else if (le === "gpu-buffer" && j > 0) {
                  let _ = s.jsepGetBuffer;
                  if (!_) throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');
                  let L = _(C), V = ae(ye, j);
                  ...
                  let _ = s.webnnEnsureTensor, L = s.webnnIsGraphInputOutputTypeSupported;
                  if (!_ || !L) throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');
                  if (ae(ye, j) === void 0 || !We(P)) throw new Error(`Unsupported data type: ${P}`);
                  if (!L(e, P, false)) throw new Error(`preferredLocation "ml-tensor" for ${P} output is not supported by current WebNN Context.`);
                  let ge = await _(e, C, ye, H, false);
                  oe = true, z.push([P, H, { mlTensor: ge, download: s.webnnCreateMLTensorDownloader(C, P), dispose: () => {
                    s.webnnReleaseTensorId(C), s._OrtReleaseTensor(G);
                  } }, "ml-tensor"]);
                } else if (le === "ml-tensor-cpu-output" && j > 0) {
                  let _ = s.webnnCreateMLTensorDownloader(C, P)(), L = z.length;
                  oe = true, pt.push((async () => {
                    let V = [L, await _];
                    return s.webnnReleaseTensorId(C), s._OrtReleaseTensor(G), V;
                  })()), z.push([P, H, [], "cpu"]);
                } else {
                  let _ = un(P), L = new _(j);
      ...
      var ne, W, be, $e, ze, Ge, ft, ct, fe, ce, Jn, pn, mn, wn, hn, bn, yn, gn, dt = E(() => {
        "use strict";
        X();
        rt();
        ee();
        Oe();
        ne = () => !!A.wasm.proxy && typeof document < "u", be = false, $e = false, ze = false, ct = /* @__PURE__ */ new Map(), fe = (e, t) => {
          let n = ct.get(e);
          n ? n.push(t) : ct.set(e, [t]);
        }, ce = () => {
          if (be || !$e || ze || !W) throw new Error("worker not ready");
        }, Jn = (e) => {
          switch (e.data.type) {
            case "init-wasm":
              be = false, e.data.err ? (ze = true, ft[1](e.data.err)) : ($e = true, ft[0]()), Ge && (URL.revokeObjectURL(Ge), Ge = void 0);
              break;
            case "init-ep":
            case "copy-from":
            case "create":
          ...
          if (!$e) {
            ...
            if (be = true, ne()) return new Promise((e, t) => {
            ...
            try {
              await Be(A.wasm), await Le(A), $e = true;
            } catch (e) {
              throw ze = true, e;
            } finally {
              be = false;
      ...
      var En, Yn, He, Sn = E(() => {
        ...
        En = (e, t) => {
          ...
          async fetchModelAndCopyToWasmMemory(t) {
            return wn(await he(t));
          }
          async loadModel(t, n) {
            J();
            let o;
            typeof t == "string" ? o = await this.fetchModelAndCopyToWasmMemory(t) : o = t, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await hn(o, n), Y();
          }
          async dispose() {
      ...
      var In = {};
      Ee(In, { OnnxruntimeWebAssemblyBackend: () => je, initializeFlags: () => Tn, wasmBackend: () => qn });
      var Tn, je, qn, An = E(() => {
        "use strict";
        X();
        dt();
        ...
        Tn = () => {
          ...
          if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), A.wasm.simd = false), typeof A.wasm.proxy != "boolean" && (A.wasm.proxy = false), typeof A.wasm.trace != "boolean" && (A.wasm.trace = false), typeof A.wasm.numThreads != "number" || !Number.isInteger(A.wasm.numThreads) || A.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) A.wasm.numThreads = 1;
            ...
            let t = typeof navigator > "u" ? Ye("node:os").cpus().length : navigator.hardwareConcurrency;
      ...
      var Xn = {};
      Ee(Xn, { InferenceSession: () => Wt, TRACE: () => et, TRACE_EVENT_BEGIN: () => q, TRACE_EVENT_END: () => Z, TRACE_FUNC_BEGIN: () => J, TRACE_FUNC_END: () => Y, Tensor: () => k, default: () => Zn, env: () => A, registerBackend: () => se });
      X();
      X();
      X();
      var Vt = "1.24.3";
...
var require_real_time_vad = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/real-time-vad.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
var require_dist = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
